# @FattureincloudFattureincloudJsSdk.UserApi
...
let apiInstance = new @FattureincloudFattureincloudJsSdk.UserApi();
...
let apiInstance = new @FattureincloudFattureincloudJsSdk.UserApi();
apiInstance.listUserCompanies((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
