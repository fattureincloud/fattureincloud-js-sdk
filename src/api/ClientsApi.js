...
export default class ClientsApi {
  ...
  /**
     ...
     * @param {Number} companyId The ID of the company.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetEntityClientPreCreateInfoResponse} and HTTP response
     */
  getClientInfoWithHttpInfo (companyId) {
    const postBody = null
    // verify the required parameter 'companyId' is set
    if (companyId === undefined || companyId === null) {
      throw new Error("Missing the required parameter 'companyId' when calling getClientInfo")
    }
    ...
    const contentTypes = []
    const accepts = ['application/json']
    const returnType = GetEntityClientPreCreateInfoResponse
    return this.apiClient.callApi(
      '/c/{company_id}/entities/clients/info', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType, null
    )
  }
  ...
  /**
     ...
     * Retrieves the information useful while creating a new Client.
     * @param {Number} companyId The ID of the company.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetEntityClientPreCreateInfoResponse}
     */
  getClientInfo (companyId) {
    return this.getClientInfoWithHttpInfo(companyId)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
