...
export default class SettingsApi {
    ...
    */
    ...
    createVatTypeWithHttpInfo(companyId, opts) {
      opts = opts || {};
      let postBody = opts['createVatTypeRequest'];
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = CreateVatTypeResponse;
      return this.apiClient.callApi(
    ...
    getVatTypeWithHttpInfo(companyId, vatTypeId) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetVatTypeResponse;
      return this.apiClient.callApi(
    ...
    modifyVatTypeWithHttpInfo(companyId, vatTypeId, opts) {
      opts = opts || {};
      let postBody = opts['modifyVatTypeRequest'];
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ModifyVatTypeResponse;
      return this.apiClient.callApi(
