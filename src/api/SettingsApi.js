...
export default class SettingsApi {
  ...
  /**
     ...
     * @param {String} [fields] List of comma-separated fields.
     * @param {module:model/String} [fieldset] Name of the fieldset.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetTemplatesResponse} and HTTP response
     */
  getTemplateWithHttpInfo (companyId, templateId, opts) {
    opts = opts || {}
    const postBody = null
    // verify the required parameter 'companyId' is set
    if (companyId === undefined || companyId === null) {
      throw new Error("Missing the required parameter 'companyId' when calling getTemplate")
    }
    ...
    const contentTypes = []
    const accepts = ['application/json']
    const returnType = GetTemplatesResponse
    return this.apiClient.callApi(
      '/c/{company_id}/settings/templates/{template_id}', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType, null
    )
  }
  ...
  /**
     ...
     * @param {String} opts.fields List of comma-separated fields.
     * @param {module:model/String} opts.fieldset Name of the fieldset.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetTemplatesResponse}
     */
  getTemplate (companyId, templateId, opts) {
    return this.getTemplateWithHttpInfo(companyId, templateId, opts)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
  ...
  /**
     ...
     */
  listTemplatesWithHttpInfo (companyId, opts) {
    opts = opts || {}
    const postBody = null
    // verify the required parameter 'companyId' is set
    if (companyId === undefined || companyId === null) {
      throw new Error("Missing the required parameter 'companyId' when calling listTemplates")
    }
    ...
    return this.apiClient.callApi(
      '/c/{company_id}/settings/templates', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType, null
    )
  }
  ...
  /**
     ...
     */
  listTemplates (companyId, opts) {
    return this.listTemplatesWithHttpInfo(companyId, opts)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
