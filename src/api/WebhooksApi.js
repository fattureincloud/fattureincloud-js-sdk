...
export default class WebhooksApi {
  ...
  /**
     ...
     * @param {String} subscriptionId The ID of the subscription.
     * @param {Object} opts Optional parameters
     * @param {module:model/VerifyWebhooksSubscriptionRequest} [verifyWebhooksSubscriptionRequest]
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
  verifyWebhooksSubscriptionWithHttpInfo (companyId, subscriptionId, opts) {
    opts = opts || {}
    const postBody = opts.verifyWebhooksSubscriptionRequest
    // verify the required parameter 'companyId' is set
    if (companyId === undefined || companyId === null) {
      throw new Error("Missing the required parameter 'companyId' when calling verifyWebhooksSubscription")
    }
    // verify the required parameter 'subscriptionId' is set
    if (subscriptionId === undefined || subscriptionId === null) {
      throw new Error("Missing the required parameter 'subscriptionId' when calling verifyWebhooksSubscription")
    }
    ...
    const returnType = null
    return this.apiClient.callApi(
      '/c/{company_id}/subscriptions/{subscription_id}/verify', 'POST',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType, null
    )
  }
  ...
  /**
     ...
     * @param {String} subscriptionId The ID of the subscription.
     * @param {Object} opts Optional parameters
     * @param {module:model/VerifyWebhooksSubscriptionRequest} opts.verifyWebhooksSubscriptionRequest
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
  verifyWebhooksSubscription (companyId, subscriptionId, opts) {
    return this.verifyWebhooksSubscriptionWithHttpInfo(companyId, subscriptionId, opts)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
