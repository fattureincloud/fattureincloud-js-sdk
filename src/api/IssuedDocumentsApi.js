...
export default class IssuedDocumentsApi {
  ...
  /**
     ...
     * @param {module:model/String} [parameter] Type of the parameters to be joined
  ...
  /**
     ...
     * @param {module:model/String} opts.parameter Type of the parameters to be joined
  ...
  /**
     ...
     * @param {String} newType New document type.
     * @param {Object} opts Optional parameters
     * @param {String} opts.parameter Old document type.
