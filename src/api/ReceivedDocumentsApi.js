...
export default class ReceivedDocumentsApi {
  ...
  /**
     ...
     * @param {Number} companyId The ID of the company.
     * @param {Number} documentId The ID of the document.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetBinReceivedDocumentResponse} and HTTP response
     */
  getBinReceivedDocumentWithHttpInfo (companyId, documentId) {
    ...
    const contentTypes = []
    const accepts = ['application/json']
    const returnType = GetBinReceivedDocumentResponse
    return this.apiClient.callApi(
  ...
  /**
     ...
     * @param {Number} companyId The ID of the company.
     * @param {Number} documentId The ID of the document.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetBinReceivedDocumentResponse}
     */
  ...
  /**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetPendingReceivedDocumentResponse} and HTTP response
     */
  getPendingReceivedDocumentWithHttpInfo (companyId, documentId, opts) {
    opts = opts || {}
    const postBody = null
    // verify the required parameter 'companyId' is set
    if (companyId === undefined || companyId === null) {
      throw new Error("Missing the required parameter 'companyId' when calling getPendingReceivedDocument")
    }
    // verify the required parameter 'documentId' is set
    if (documentId === undefined || documentId === null) {
      throw new Error("Missing the required parameter 'documentId' when calling getPendingReceivedDocument")
    }
    ...
    const contentTypes = []
    const accepts = ['application/json']
    const returnType = GetPendingReceivedDocumentResponse
    return this.apiClient.callApi(
      '/c/{company_id}/received_documents/pending/{document_id}', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType, null
    )
  }
  ...
  /**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetPendingReceivedDocumentResponse}
     */
  getPendingReceivedDocument (companyId, documentId, opts) {
    return this.getPendingReceivedDocumentWithHttpInfo(companyId, documentId, opts)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
  ...
  /**
     ...
     * @param {Number} companyId The ID of the company.
     * @param {module:model/String} type The type of the pending received document.
     * @param {Object} opts Optional parameters
     * @param {String} [fields] List of comma-separated fields.
     * @param {module:model/String} [fieldset] Name of the fieldset.
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ListPendingReceivedDocumentsResponse} and HTTP response
     */
  listPendingReceivedDocumentsWithHttpInfo (companyId, type, opts) {
    opts = opts || {}
    const postBody = null
    // verify the required parameter 'companyId' is set
    if (companyId === undefined || companyId === null) {
      throw new Error("Missing the required parameter 'companyId' when calling listPendingReceivedDocuments")
    }
    // verify the required parameter 'type' is set
    if (type === undefined || type === null) {
      throw new Error("Missing the required parameter 'type' when calling listPendingReceivedDocuments")
    }
    ...
    const contentTypes = []
    const accepts = ['application/json']
    const returnType = ListPendingReceivedDocumentsResponse
    return this.apiClient.callApi(
      '/c/{company_id}/received_documents/pending', 'GET',
      pathParams, queryParams, headerParams, formParams, postBody,
      authNames, contentTypes, accepts, returnType, null
    )
  }
  ...
  /**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ListPendingReceivedDocumentsResponse}
     */
  listPendingReceivedDocuments (companyId, type, opts) {
    return this.listPendingReceivedDocumentsWithHttpInfo(companyId, type, opts)
      .then(function (response_and_data) {
        return response_and_data.data
      })
  }
