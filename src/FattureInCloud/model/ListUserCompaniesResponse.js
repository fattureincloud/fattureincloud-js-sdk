 ...
 * @module FattureInCloud/model/ListUserCompaniesResponse
 * @version 2.0.1
 */
class ListUserCompaniesResponse {
    /**
     * Constructs a new <code>ListUserCompaniesResponse</code>.
     * The UserCompany response.
     * @alias module:FattureInCloud/model/ListUserCompaniesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListUserCompaniesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListUserCompaniesResponse} The populated <code>ListUserCompaniesResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/ListUserCompaniesResponseData} data
 */
