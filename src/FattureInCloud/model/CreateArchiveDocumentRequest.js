 ...
 * @module FattureInCloud/model/CreateArchiveDocumentRequest
 * @version 2.0.1
 */
class CreateArchiveDocumentRequest {
     ...
     * Archive Document
     * @alias module:FattureInCloud/model/CreateArchiveDocumentRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateArchiveDocumentRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateArchiveDocumentRequest} The populated <code>CreateArchiveDocumentRequest</code> instance.
     */
