 ...
 * @module FattureInCloud/model/ReceiptItemsListItem
 * @version 2.0.1
 */
class ReceiptItemsListItem {
    /**
     * Constructs a new <code>ReceiptItemsListItem</code>.
     * @alias module:FattureInCloud/model/ReceiptItemsListItem
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceiptItemsListItem} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceiptItemsListItem} The populated <code>ReceiptItemsListItem</code> instance.
     */
