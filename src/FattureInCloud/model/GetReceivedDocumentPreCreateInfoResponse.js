 ...
 * @module FattureInCloud/model/GetReceivedDocumentPreCreateInfoResponse
 * @version 2.0.1
 */
class GetReceivedDocumentPreCreateInfoResponse {
    /**
     * Constructs a new <code>GetReceivedDocumentPreCreateInfoResponse</code>.
     * Received Document Info
     * @alias module:FattureInCloud/model/GetReceivedDocumentPreCreateInfoResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetReceivedDocumentPreCreateInfoResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetReceivedDocumentPreCreateInfoResponse} The populated <code>GetReceivedDocumentPreCreateInfoResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/ReceivedDocumentInfo} data
 */
