 ...
 * @module FattureInCloud/model/ReceivedDocumentEntity
 * @version 2.0.1
 */
class ReceivedDocumentEntity {
    /**
     * Constructs a new <code>ReceivedDocumentEntity</code>.
     * @alias module:FattureInCloud/model/ReceivedDocumentEntity
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocumentEntity} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocumentEntity} The populated <code>ReceivedDocumentEntity</code> instance.
     */
