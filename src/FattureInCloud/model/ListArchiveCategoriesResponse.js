 ...
 * @module FattureInCloud/model/ListArchiveCategoriesResponse
 * @version 2.0.1
 */
class ListArchiveCategoriesResponse {
    /**
     * Constructs a new <code>ListArchiveCategoriesResponse</code>.
     * @alias module:FattureInCloud/model/ListArchiveCategoriesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListArchiveCategoriesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListArchiveCategoriesResponse} The populated <code>ListArchiveCategoriesResponse</code> instance.
     */
