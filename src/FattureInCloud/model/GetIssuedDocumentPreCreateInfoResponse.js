 ...
 * @module FattureInCloud/model/GetIssuedDocumentPreCreateInfoResponse
 * @version 2.0.1
 */
class GetIssuedDocumentPreCreateInfoResponse {
    /**
     * Constructs a new <code>GetIssuedDocumentPreCreateInfoResponse</code>.
     * @alias module:FattureInCloud/model/GetIssuedDocumentPreCreateInfoResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetIssuedDocumentPreCreateInfoResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetIssuedDocumentPreCreateInfoResponse} The populated <code>GetIssuedDocumentPreCreateInfoResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/IssuedDocumentPreCreateInfo} data
 */
