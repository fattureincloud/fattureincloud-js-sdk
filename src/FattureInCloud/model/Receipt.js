 ...
 * @module FattureInCloud/model/Receipt
 * @version 2.0.1
 */
class Receipt {
    /**
     ...
     * Receipt
     * @alias module:FattureInCloud/model/Receipt
     * @param date {Date} Receipt date.
     * @param type {module:FattureInCloud/model/ReceiptType} 
     * @param paymentAccount {module:FattureInCloud/model/PaymentAccount} 
     */
    constructor(date, type, paymentAccount) { 
        
        Receipt.initialize(this, date, type, paymentAccount);
    }
     ...
     */
    static initialize(obj, date, type, paymentAccount) { 
        obj['date'] = date;
        obj['type'] = type;
     ...
     * @param {module:FattureInCloud/model/Receipt} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/Receipt} The populated <code>Receipt</code> instance.
     */
 ...
 * @default false
 */
Receipt.prototype['use_gross_prices'] = false;

/**
 * @member {module:FattureInCloud/model/ReceiptType} type
 */
...
/**
 * @member {Array.<module:FattureInCloud/model/ReceiptItemsListItem>} items_list
 */
