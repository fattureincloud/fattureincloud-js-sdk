 ...
 * @module FattureInCloud/model/EmailSchedule
 * @version 2.0.1
 */
class EmailSchedule {
    /**
     * Constructs a new <code>EmailSchedule</code>.
     * @alias module:FattureInCloud/model/EmailSchedule
     * @param recipientEmail {String} One or more comma separated recipient emails
     * @param subject {String} Email subject
     * @param body {String} Email body
     * @param include {module:FattureInCloud/model/EmailScheduleInclude} 
     ...
     * @param {module:FattureInCloud/model/EmailSchedule} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/EmailSchedule} The populated <code>EmailSchedule</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/EmailScheduleInclude} include
 */
