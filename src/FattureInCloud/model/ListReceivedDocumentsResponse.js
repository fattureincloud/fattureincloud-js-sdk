 ...
 * @module FattureInCloud/model/ListReceivedDocumentsResponse
 * @version 2.0.1
 */
class ListReceivedDocumentsResponse {
     ...
     * Results list.
     * @alias module:FattureInCloud/model/ListReceivedDocumentsResponse
     * @implements module:FattureInCloud/model/Pagination
     * @implements module:FattureInCloud/model/ListReceivedDocumentsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListReceivedDocumentsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListReceivedDocumentsResponse} The populated <code>ListReceivedDocumentsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/ReceivedDocument>} data
 */
