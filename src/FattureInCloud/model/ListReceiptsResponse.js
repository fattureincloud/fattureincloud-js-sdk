 ...
 * @module FattureInCloud/model/ListReceiptsResponse
 * @version 2.0.1
 */
class ListReceiptsResponse {
     ...
     * Receipts list.
     * @alias module:FattureInCloud/model/ListReceiptsResponse
     * @implements module:FattureInCloud/model/Pagination
     * @implements module:FattureInCloud/model/ListReceiptsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListReceiptsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListReceiptsResponse} The populated <code>ListReceiptsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/Receipt>} data
 */
