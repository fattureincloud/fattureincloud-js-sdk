 ...
 * @module FattureInCloud/model/GetExistingReceivedDocumentTotalsRequest
 * @version 2.0.1
 */
class GetExistingReceivedDocumentTotalsRequest {
     ...
     * Received Document. 
     * @alias module:FattureInCloud/model/GetExistingReceivedDocumentTotalsRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetExistingReceivedDocumentTotalsRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetExistingReceivedDocumentTotalsRequest} The populated <code>GetExistingReceivedDocumentTotalsRequest</code> instance.
     */
