 ...
 * @module FattureInCloud/model/GetCashbookEntryResponse
 * @version 2.0.1
 */
class GetCashbookEntryResponse {
     ...
     * Cashbook Entry
     * @alias module:FattureInCloud/model/GetCashbookEntryResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetCashbookEntryResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetCashbookEntryResponse} The populated <code>GetCashbookEntryResponse</code> instance.
     */
