 ...
 * @module FattureInCloud/model/GetNewIssuedDocumentTotalsRequest
 * @version 2.0.1
 */
class GetNewIssuedDocumentTotalsRequest {
    /**
     * Constructs a new <code>GetNewIssuedDocumentTotalsRequest</code>.
     * @alias module:FattureInCloud/model/GetNewIssuedDocumentTotalsRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetNewIssuedDocumentTotalsRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetNewIssuedDocumentTotalsRequest} The populated <code>GetNewIssuedDocumentTotalsRequest</code> instance.
     */
