 ...
 * @module FattureInCloud/model/GetCompanyInfoResponse
 * @version 2.0.1
 */
class GetCompanyInfoResponse {
    /**
     * Constructs a new <code>GetCompanyInfoResponse</code>.
     * The CompanyInfo response.
     * @alias module:FattureInCloud/model/GetCompanyInfoResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetCompanyInfoResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetCompanyInfoResponse} The populated <code>GetCompanyInfoResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/CompanyInfo} data
 */
