 ...
 * @module FattureInCloud/model/ListProductCategoriesResponse
 * @version 2.0.1
 */
class ListProductCategoriesResponse {
     ...
     * @alias module:FattureInCloud/model/ListProductCategoriesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListProductCategoriesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListProductCategoriesResponse} The populated <code>ListProductCategoriesResponse</code> instance.
     */
