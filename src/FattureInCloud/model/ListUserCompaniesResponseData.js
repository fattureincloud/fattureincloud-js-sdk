 ...
 * @module FattureInCloud/model/ListUserCompaniesResponseData
 * @version 2.0.1
 */
class ListUserCompaniesResponseData {
    /**
     * Constructs a new <code>ListUserCompaniesResponseData</code>.
     * @alias module:FattureInCloud/model/ListUserCompaniesResponseData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListUserCompaniesResponseData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListUserCompaniesResponseData} The populated <code>ListUserCompaniesResponseData</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/Company>} companies
 */
