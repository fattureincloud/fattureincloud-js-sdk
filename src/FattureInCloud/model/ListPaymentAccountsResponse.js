 ...
 * @module FattureInCloud/model/ListPaymentAccountsResponse
 * @version 2.0.1
 */
class ListPaymentAccountsResponse {
     ...
     * @alias module:FattureInCloud/model/ListPaymentAccountsResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListPaymentAccountsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListPaymentAccountsResponse} The populated <code>ListPaymentAccountsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/PaymentAccount>} data
 */
