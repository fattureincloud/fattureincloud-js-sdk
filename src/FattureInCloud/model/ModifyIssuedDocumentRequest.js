 ...
 * @module FattureInCloud/model/ModifyIssuedDocumentRequest
 * @version 2.0.1
 */
class ModifyIssuedDocumentRequest {
     ...
     * The issued document
     * @alias module:FattureInCloud/model/ModifyIssuedDocumentRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyIssuedDocumentRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyIssuedDocumentRequest} The populated <code>ModifyIssuedDocumentRequest</code> instance.
     */
