 ...
 * @module FattureInCloud/model/ListReceivedDocumentCategoriesResponse
 * @version 2.0.1
 */
class ListReceivedDocumentCategoriesResponse {
     ...
     * @alias module:FattureInCloud/model/ListReceivedDocumentCategoriesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListReceivedDocumentCategoriesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListReceivedDocumentCategoriesResponse} The populated <code>ListReceivedDocumentCategoriesResponse</code> instance.
     */
