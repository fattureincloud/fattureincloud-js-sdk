 ...
 * @module FattureInCloud/model/ListClientsResponse
 * @version 2.0.1
 */
class ListClientsResponse {
    /**
     * Constructs a new <code>ListClientsResponse</code>.
     * @alias module:FattureInCloud/model/ListClientsResponse
     * @implements module:FattureInCloud/model/Pagination
     * @implements module:FattureInCloud/model/ListClientsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListClientsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListClientsResponse} The populated <code>ListClientsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/Client>} data
 */
