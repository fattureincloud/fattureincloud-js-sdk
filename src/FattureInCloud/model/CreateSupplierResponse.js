 ...
 * @module FattureInCloud/model/CreateSupplierResponse
 * @version 2.0.1
 */
class CreateSupplierResponse {
    /**
     * Constructs a new <code>CreateSupplierResponse</code>.
     * @alias module:FattureInCloud/model/CreateSupplierResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateSupplierResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateSupplierResponse} The populated <code>CreateSupplierResponse</code> instance.
     */
