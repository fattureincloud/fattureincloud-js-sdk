 ...
 * @module FattureInCloud/model/ModifyCashbookEntryRequest
 * @version 2.0.1
 */
class ModifyCashbookEntryRequest {
     ...
     * Cashbook Entry.
     * @alias module:FattureInCloud/model/ModifyCashbookEntryRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyCashbookEntryRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyCashbookEntryRequest} The populated <code>ModifyCashbookEntryRequest</code> instance.
     */
