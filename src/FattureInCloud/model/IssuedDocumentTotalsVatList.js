 ...
 * @module FattureInCloud/model/IssuedDocumentTotalsVatList
 * @version 2.0.1
 */
class IssuedDocumentTotalsVatList {
    /**
     * Constructs a new <code>IssuedDocumentTotalsVatList</code>.
     * @alias module:FattureInCloud/model/IssuedDocumentTotalsVatList
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentTotalsVatList} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentTotalsVatList} The populated <code>IssuedDocumentTotalsVatList</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/IssuedDocumentTotalsVatListVatItem} vat_item
 */
