 ...
 * @module FattureInCloud/model/ModifyClientResponse
 * @version 2.0.1
 */
class ModifyClientResponse {
    /**
     * Constructs a new <code>ModifyClientResponse</code>.
     * @alias module:FattureInCloud/model/ModifyClientResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyClientResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyClientResponse} The populated <code>ModifyClientResponse</code> instance.
     */
