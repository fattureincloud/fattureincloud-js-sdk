 ...
 * @module FattureInCloud/model/CreateProductResponse
 * @version 2.0.1
 */
class CreateProductResponse {
    /**
     * Constructs a new <code>CreateProductResponse</code>.
     * @alias module:FattureInCloud/model/CreateProductResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateProductResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateProductResponse} The populated <code>CreateProductResponse</code> instance.
     */
