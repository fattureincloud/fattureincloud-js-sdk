 ...
 * @module FattureInCloud/model/ListReceivedDocumentsResponsePage
 * @version 2.0.1
 */
class ListReceivedDocumentsResponsePage {
    /**
     * Constructs a new <code>ListReceivedDocumentsResponsePage</code>.
     * @alias module:FattureInCloud/model/ListReceivedDocumentsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListReceivedDocumentsResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListReceivedDocumentsResponsePage} The populated <code>ListReceivedDocumentsResponsePage</code> instance.
     */
