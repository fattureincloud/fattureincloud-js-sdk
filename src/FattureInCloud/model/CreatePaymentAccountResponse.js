 ...
 * @module FattureInCloud/model/CreatePaymentAccountResponse
 * @version 2.0.1
 */
class CreatePaymentAccountResponse {
    /**
     * Constructs a new <code>CreatePaymentAccountResponse</code>.
     * @alias module:FattureInCloud/model/CreatePaymentAccountResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreatePaymentAccountResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreatePaymentAccountResponse} The populated <code>CreatePaymentAccountResponse</code> instance.
     */
