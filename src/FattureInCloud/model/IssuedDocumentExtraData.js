 ...
 * @module FattureInCloud/model/IssuedDocumentExtraData
 * @version 2.0.1
 */
class IssuedDocumentExtraData {
     ...
     * @alias module:FattureInCloud/model/IssuedDocumentExtraData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentExtraData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentExtraData} The populated <code>IssuedDocumentExtraData</code> instance.
     */
