 ...
 * @module FattureInCloud/model/GetUserInfoResponse
 * @version 2.0.1
 */
class GetUserInfoResponse {
     ...
     * 
     * @alias module:FattureInCloud/model/GetUserInfoResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetUserInfoResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetUserInfoResponse} The populated <code>GetUserInfoResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/User} data
 */
GetUserInfoResponse.prototype['data'] = undefined;

/**
 * @member {module:FattureInCloud/model/GetUserInfoResponseInfo} info
 */
GetUserInfoResponse.prototype['info'] = undefined;

/**
 * @member {module:FattureInCloud/model/GetUserInfoResponseEmailConfirmationState} email_confirmation_state
 */
