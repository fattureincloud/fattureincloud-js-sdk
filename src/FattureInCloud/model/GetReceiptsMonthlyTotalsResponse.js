 ...
 * @module FattureInCloud/model/GetReceiptsMonthlyTotalsResponse
 * @version 2.0.1
 */
class GetReceiptsMonthlyTotalsResponse {
     ...
     * Monthly totals.
     * @alias module:FattureInCloud/model/GetReceiptsMonthlyTotalsResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetReceiptsMonthlyTotalsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetReceiptsMonthlyTotalsResponse} The populated <code>GetReceiptsMonthlyTotalsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/MonthlyTotal>} data
 */
