 ...
 * @module FattureInCloud/model/GetSupplierResponse
 * @version 2.0.1
 */
class GetSupplierResponse {
    /**
     * Constructs a new <code>GetSupplierResponse</code>.
     * @alias module:FattureInCloud/model/GetSupplierResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetSupplierResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetSupplierResponse} The populated <code>GetSupplierResponse</code> instance.
     */
