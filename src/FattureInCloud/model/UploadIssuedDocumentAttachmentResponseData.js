 ...
 * @module FattureInCloud/model/UploadIssuedDocumentAttachmentResponseData
 * @version 2.0.1
 */
class UploadIssuedDocumentAttachmentResponseData {
    /**
     * Constructs a new <code>UploadIssuedDocumentAttachmentResponseData</code>.
     * @alias module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponseData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponseData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponseData} The populated <code>UploadIssuedDocumentAttachmentResponseData</code> instance.
     */
