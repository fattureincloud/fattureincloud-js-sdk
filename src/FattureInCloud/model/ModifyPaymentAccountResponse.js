 ...
 * @module FattureInCloud/model/ModifyPaymentAccountResponse
 * @version 2.0.1
 */
class ModifyPaymentAccountResponse {
    /**
     * Constructs a new <code>ModifyPaymentAccountResponse</code>.
     * @alias module:FattureInCloud/model/ModifyPaymentAccountResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyPaymentAccountResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyPaymentAccountResponse} The populated <code>ModifyPaymentAccountResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/PaymentAccount} data
 */
