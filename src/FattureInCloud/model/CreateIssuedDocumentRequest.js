 ...
 * @module FattureInCloud/model/CreateIssuedDocumentRequest
 * @version 2.0.1
 */
class CreateIssuedDocumentRequest {
    /**
     * Constructs a new <code>CreateIssuedDocumentRequest</code>.
     * @alias module:FattureInCloud/model/CreateIssuedDocumentRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateIssuedDocumentRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateIssuedDocumentRequest} The populated <code>CreateIssuedDocumentRequest</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/IssuedDocument} data
 */
CreateIssuedDocumentRequest.prototype['data'] = undefined;

/**
 * @member {module:FattureInCloud/model/EntityOptions} options
 */
