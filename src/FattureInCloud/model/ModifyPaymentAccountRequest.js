 ...
 * @module FattureInCloud/model/ModifyPaymentAccountRequest
 * @version 2.0.1
 */
class ModifyPaymentAccountRequest {
    /**
     * Constructs a new <code>ModifyPaymentAccountRequest</code>.
     * @alias module:FattureInCloud/model/ModifyPaymentAccountRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyPaymentAccountRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyPaymentAccountRequest} The populated <code>ModifyPaymentAccountRequest</code> instance.
     */
