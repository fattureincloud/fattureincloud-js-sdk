 ...
 * @module FattureInCloud/model/ListProductsResponsePage
 * @version 2.0.1
 */
class ListProductsResponsePage {
    /**
     * Constructs a new <code>ListProductsResponsePage</code>.
     * @alias module:FattureInCloud/model/ListProductsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListProductsResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListProductsResponsePage} The populated <code>ListProductsResponsePage</code> instance.
     */
