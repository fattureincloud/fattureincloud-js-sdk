 ...
 * @module FattureInCloud/model/IssuedDocumentTotals
 * @version 2.0.1
 */
class IssuedDocumentTotals {
    /**
     * Constructs a new <code>IssuedDocumentTotals</code>.
     * @alias module:FattureInCloud/model/IssuedDocumentTotals
     ...
     * @param isEnasarcoMaximalExceeded {Boolean} 
     * @param paymentsSum {Number} Payments sum.
     */
    constructor(amountNet, amountVat, amountGross, amountDue, isEnasarcoMaximalExceeded, paymentsSum) { 
        
        IssuedDocumentTotals.initialize(this, amountNet, amountVat, amountGross, amountDue, isEnasarcoMaximalExceeded, paymentsSum);
    }
     ...
     */
    static initialize(obj, amountNet, amountVat, amountGross, amountDue, isEnasarcoMaximalExceeded, paymentsSum) { 
        obj['amount_net'] = amountNet;
        obj['amount_vat'] = amountVat;
        obj['amount_gross'] = amountGross;
        obj['amount_due'] = amountDue;
        obj['is_enasarco_maximal_exceeded'] = isEnasarcoMaximalExceeded;
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentTotals} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentTotals} The populated <code>IssuedDocumentTotals</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/IssuedDocumentTotalsVatList} vat_list
 */
