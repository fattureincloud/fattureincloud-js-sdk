 ...
 * @module FattureInCloud/model/GetExistingReceivedDocumentTotalsResponse
 * @version 2.0.1
 */
class GetExistingReceivedDocumentTotalsResponse {
     ...
     * Document Totals.
     * @alias module:FattureInCloud/model/GetExistingReceivedDocumentTotalsResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetExistingReceivedDocumentTotalsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetExistingReceivedDocumentTotalsResponse} The populated <code>GetExistingReceivedDocumentTotalsResponse</code> instance.
     */
