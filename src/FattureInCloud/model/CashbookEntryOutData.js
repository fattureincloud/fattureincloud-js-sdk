 ...
 * @module FattureInCloud/model/CashbookEntryOutData
 * @version 2.0.1
 */
class CashbookEntryOutData {
    /**
     * Constructs a new <code>CashbookEntryOutData</code>.
     * @alias module:FattureInCloud/model/CashbookEntryOutData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CashbookEntryOutData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CashbookEntryOutData} The populated <code>CashbookEntryOutData</code> instance.
     */
