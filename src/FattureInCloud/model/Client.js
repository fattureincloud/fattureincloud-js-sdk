 ...
 * @module FattureInCloud/model/Client
 * @version 2.0.1
 */
class Client {
    /**
     ...
     * Client.
     * @alias module:FattureInCloud/model/Client
     ...
     * @param {module:FattureInCloud/model/Client} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/Client} The populated <code>Client</code> instance.
     */
 ...
 * @readonly
 */
Client['DefaultPaymentTermsTypeEnum'] = {
