 ...
 * @module FattureInCloud/model/ModifyReceiptResponse
 * @version 2.0.1
 */
class ModifyReceiptResponse {
     ...
     * Modified receipt.
     * @alias module:FattureInCloud/model/ModifyReceiptResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyReceiptResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyReceiptResponse} The populated <code>ModifyReceiptResponse</code> instance.
     */
