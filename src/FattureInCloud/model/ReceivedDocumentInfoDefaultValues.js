 ...
 * @module FattureInCloud/model/ReceivedDocumentInfoDefaultValues
 * @version 2.0.1
 */
class ReceivedDocumentInfoDefaultValues {
     ...
     * @alias module:FattureInCloud/model/ReceivedDocumentInfoDefaultValues
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocumentInfoDefaultValues} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocumentInfoDefaultValues} The populated <code>ReceivedDocumentInfoDefaultValues</code> instance.
     */
