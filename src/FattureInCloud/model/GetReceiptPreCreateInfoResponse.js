 ...
 * @module FattureInCloud/model/GetReceiptPreCreateInfoResponse
 * @version 2.0.1
 */
class GetReceiptPreCreateInfoResponse {
     ...
     * Pre-create info.
     * @alias module:FattureInCloud/model/GetReceiptPreCreateInfoResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetReceiptPreCreateInfoResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetReceiptPreCreateInfoResponse} The populated <code>GetReceiptPreCreateInfoResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/ReceiptPreCreateInfo} data
 */
