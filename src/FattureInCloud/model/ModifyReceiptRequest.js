 ...
 * @module FattureInCloud/model/ModifyReceiptRequest
 * @version 2.0.1
 */
class ModifyReceiptRequest {
     ...
     * Modified receipt.
     * @alias module:FattureInCloud/model/ModifyReceiptRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyReceiptRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyReceiptRequest} The populated <code>ModifyReceiptRequest</code> instance.
     */
