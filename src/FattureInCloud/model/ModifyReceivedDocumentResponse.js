 ...
 * @module FattureInCloud/model/ModifyReceivedDocumentResponse
 * @version 2.0.1
 */
class ModifyReceivedDocumentResponse {
     ...
     * Received document.
     * @alias module:FattureInCloud/model/ModifyReceivedDocumentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyReceivedDocumentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyReceivedDocumentResponse} The populated <code>ModifyReceivedDocumentResponse</code> instance.
     */
