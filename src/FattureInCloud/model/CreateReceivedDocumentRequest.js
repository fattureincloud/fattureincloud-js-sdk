 ...
 * @module FattureInCloud/model/CreateReceivedDocumentRequest
 * @version 2.0.1
 */
class CreateReceivedDocumentRequest {
     ...
     * Received document.
     * @alias module:FattureInCloud/model/CreateReceivedDocumentRequest
     * @param data {module:FattureInCloud/model/ReceivedDocument} 
     */
    constructor(data) { 
     ...
     * @param {module:FattureInCloud/model/CreateReceivedDocumentRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateReceivedDocumentRequest} The populated <code>CreateReceivedDocumentRequest</code> instance.
     */
