 ...
 * @module FattureInCloud/model/CreateCashbookEntryResponse
 * @version 2.0.1
 */
class CreateCashbookEntryResponse {
    /**
     * Constructs a new <code>CreateCashbookEntryResponse</code>.
     * The created Cashbook Entry.
     * @alias module:FattureInCloud/model/CreateCashbookEntryResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateCashbookEntryResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateCashbookEntryResponse} The populated <code>CreateCashbookEntryResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/CashbookEntryInOut} data
 */
