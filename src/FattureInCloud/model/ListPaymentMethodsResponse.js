 ...
 * @module FattureInCloud/model/ListPaymentMethodsResponse
 * @version 2.0.1
 */
class ListPaymentMethodsResponse {
     ...
     * @alias module:FattureInCloud/model/ListPaymentMethodsResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListPaymentMethodsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListPaymentMethodsResponse} The populated <code>ListPaymentMethodsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/PaymentMethod>} data
 */
