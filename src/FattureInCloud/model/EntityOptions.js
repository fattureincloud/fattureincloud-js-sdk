 ...
 * @module FattureInCloud/model/EntityOptions
 * @version 2.0.1
 */
class EntityOptions {
    /**
     * Constructs a new <code>EntityOptions</code>.
     * @alias module:FattureInCloud/model/EntityOptions
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/EntityOptions} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/EntityOptions} The populated <code>EntityOptions</code> instance.
     */
