 ...
 * @module FattureInCloud/model/ListCountriesResponse
 * @version 2.0.1
 */
class ListCountriesResponse {
     ...
     * Countries list.
     * @alias module:FattureInCloud/model/ListCountriesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListCountriesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListCountriesResponse} The populated <code>ListCountriesResponse</code> instance.
     */
