 ...
 * @module FattureInCloud/model/VerifyEInvoiceXmlErrorResponseError
 * @version 2.0.1
 */
class VerifyEInvoiceXmlErrorResponseError {
    /**
     * Constructs a new <code>VerifyEInvoiceXmlErrorResponseError</code>.
     * @alias module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponseError
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponseError} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponseError} The populated <code>VerifyEInvoiceXmlErrorResponseError</code> instance.
     */
