 ...
 * @module FattureInCloud/model/PaymentMethod
 * @version 2.0.1
 */
class PaymentMethod {
    /**
     * Constructs a new <code>PaymentMethod</code>.
     * @alias module:FattureInCloud/model/PaymentMethod
     ...
     * @param {module:FattureInCloud/model/PaymentMethod} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/PaymentMethod} The populated <code>PaymentMethod</code> instance.
     */
...
/**
 * Method type
 * @member {module:FattureInCloud/model/PaymentMethod.TypeEnum} type
 * @default 'standard'
 */
...
/**
 * @member {module:FattureInCloud/model/PaymentAccount} default_payment_account
 */
PaymentMethod.prototype['default_payment_account'] = undefined;

/**
 * Method details rows
 * @member {Array.<module:FattureInCloud/model/PaymentMethodDetails>} details
 */
