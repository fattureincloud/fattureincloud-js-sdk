 ...
 * @module FattureInCloud/model/ScheduleEmailRequest
 * @version 2.0.1
 */
class ScheduleEmailRequest {
     ...
     * Email Schedule
     * @alias module:FattureInCloud/model/ScheduleEmailRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ScheduleEmailRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ScheduleEmailRequest} The populated <code>ScheduleEmailRequest</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/EmailSchedule} data
 */
