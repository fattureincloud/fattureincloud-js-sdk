 ...
 * @module FattureInCloud/model/GetPaymentMethodResponse
 * @version 2.0.1
 */
class GetPaymentMethodResponse {
    /**
     * Constructs a new <code>GetPaymentMethodResponse</code>.
     * @alias module:FattureInCloud/model/GetPaymentMethodResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetPaymentMethodResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetPaymentMethodResponse} The populated <code>GetPaymentMethodResponse</code> instance.
     */
