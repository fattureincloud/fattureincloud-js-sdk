 ...
 * @module FattureInCloud/model/ListCitiesResponse
 * @version 2.0.1
 */
class ListCitiesResponse {
     ...
     * Cities list.
     * @alias module:FattureInCloud/model/ListCitiesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListCitiesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListCitiesResponse} The populated <code>ListCitiesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/City>} data
 */
