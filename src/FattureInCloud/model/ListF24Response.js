...
import ListF24ResponseAggregatedDataAggregatedData from './ListF24ResponseAggregatedDataAggregatedData';
import ListF24ResponsePage from './ListF24ResponsePage';
import Pagination from './Pagination';

/**
 * The ListF24Response model module.
 * @module FattureInCloud/model/ListF24Response
 * @version 2.0.1
 */
class ListF24Response {
     ...
     * Results list.
     * @alias module:FattureInCloud/model/ListF24Response
     * @implements module:FattureInCloud/model/Pagination
     * @implements module:FattureInCloud/model/ListF24ResponsePage
     * @implements module:FattureInCloud/model/ListF24ResponseAggregatedData
     */
    constructor() { 
        Pagination.initialize(this);ListF24ResponsePage.initialize(this);ListF24ResponseAggregatedData.initialize(this);
     ...
     * @param {module:FattureInCloud/model/ListF24Response} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListF24Response} The populated <code>ListF24Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ListF24ResponseAggregatedData.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('aggregated_data')) {
                obj['aggregated_data'] = ListF24ResponseAggregatedDataAggregatedData.constructFromObject(data['aggregated_data']);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:FattureInCloud/model/F24>} data
 */
ListF24Response.prototype['data'] = undefined;

/**
 * @member {module:FattureInCloud/model/ListF24ResponseAggregatedDataAggregatedData} aggregated_data
 */
...
// Implement ListF24ResponseAggregatedData interface:
/**
 * @member {module:FattureInCloud/model/ListF24ResponseAggregatedDataAggregatedData} aggregated_data
 */
ListF24ResponseAggregatedData.prototype['aggregated_data'] = undefined;
