 ...
 * @module FattureInCloud/model/CompanyInfoPlanInfoLimits
 * @version 2.0.1
 */
class CompanyInfoPlanInfoLimits {
     ...
     * @alias module:FattureInCloud/model/CompanyInfoPlanInfoLimits
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CompanyInfoPlanInfoLimits} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CompanyInfoPlanInfoLimits} The populated <code>CompanyInfoPlanInfoLimits</code> instance.
     */
