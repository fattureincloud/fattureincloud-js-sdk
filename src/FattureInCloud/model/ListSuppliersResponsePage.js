 ...
 * @module FattureInCloud/model/ListSuppliersResponsePage
 * @version 2.0.1
 */
class ListSuppliersResponsePage {
    /**
     * Constructs a new <code>ListSuppliersResponsePage</code>.
     * @alias module:FattureInCloud/model/ListSuppliersResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListSuppliersResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListSuppliersResponsePage} The populated <code>ListSuppliersResponsePage</code> instance.
     */
