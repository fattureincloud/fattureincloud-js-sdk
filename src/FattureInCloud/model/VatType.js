 ...
 * @module FattureInCloud/model/VatType
 * @version 2.0.1
 */
class VatType {
    /**
     * Constructs a new <code>VatType</code>.
     * @alias module:FattureInCloud/model/VatType
     * @param value {Number} Percentual value.
     */
    constructor(value) { 
     ...
     * @param {module:FattureInCloud/model/VatType} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/VatType} The populated <code>VatType</code> instance.
     */
