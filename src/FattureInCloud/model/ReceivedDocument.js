...
import ReceivedDocumentItemsList from './ReceivedDocumentItemsList';
import ReceivedDocumentPaymentsList from './ReceivedDocumentPaymentsList';
import ReceivedDocumentType from './ReceivedDocumentType';

/**
 * The ReceivedDocument model module.
 * @module FattureInCloud/model/ReceivedDocument
 * @version 2.0.1
 */
class ReceivedDocument {
    /**
     * Constructs a new <code>ReceivedDocument</code>.
     * @alias module:FattureInCloud/model/ReceivedDocument
     * @param entity {module:FattureInCloud/model/ReceivedDocumentEntity} 
     */
    constructor(entity) { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocument} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocument} The populated <code>ReceivedDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items_list')) {
                obj['items_list'] = ApiClient.convertToType(data['items_list'], [ReceivedDocumentItemsList]);
            }
            if (data.hasOwnProperty('payments_list')) {
                obj['payments_list'] = ApiClient.convertToType(data['payments_list'], [ReceivedDocumentPaymentsList]);
            }
...
/**
 * @member {module:FattureInCloud/model/ReceivedDocumentType} type
 */
ReceivedDocument.prototype['type'] = undefined;

/**
 * @member {module:FattureInCloud/model/ReceivedDocumentEntity} entity
 */
...
/**
 * @member {Array.<module:FattureInCloud/model/ReceivedDocumentItemsList>} items_list
 */
ReceivedDocument.prototype['items_list'] = undefined;

/**
 * @member {Array.<module:FattureInCloud/model/ReceivedDocumentPaymentsList>} payments_list
 */
