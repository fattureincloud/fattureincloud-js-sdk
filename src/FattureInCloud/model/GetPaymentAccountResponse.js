 ...
 * @module FattureInCloud/model/GetPaymentAccountResponse
 * @version 2.0.1
 */
class GetPaymentAccountResponse {
    /**
     * Constructs a new <code>GetPaymentAccountResponse</code>.
     * @alias module:FattureInCloud/model/GetPaymentAccountResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetPaymentAccountResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetPaymentAccountResponse} The populated <code>GetPaymentAccountResponse</code> instance.
     */
