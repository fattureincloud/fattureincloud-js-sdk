 ...
 * @module FattureInCloud/model/SendEInvoiceResponseData
 * @version 2.0.1
 */
class SendEInvoiceResponseData {
    /**
     * Constructs a new <code>SendEInvoiceResponseData</code>.
     * @alias module:FattureInCloud/model/SendEInvoiceResponseData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/SendEInvoiceResponseData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/SendEInvoiceResponseData} The populated <code>SendEInvoiceResponseData</code> instance.
     */
