 ...
 * @module FattureInCloud/model/Language
 * @version 2.0.1
 */
class Language {
    /**
     * Constructs a new <code>Language</code>.
     * @alias module:FattureInCloud/model/Language
     ...
     * @param {module:FattureInCloud/model/Language} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/Language} The populated <code>Language</code> instance.
     */
