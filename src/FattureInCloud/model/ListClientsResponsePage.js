 ...
 * @module FattureInCloud/model/ListClientsResponsePage
 * @version 2.0.1
 */
class ListClientsResponsePage {
    /**
     * Constructs a new <code>ListClientsResponsePage</code>.
     * @alias module:FattureInCloud/model/ListClientsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListClientsResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListClientsResponsePage} The populated <code>ListClientsResponsePage</code> instance.
     */
