 ...
 * @module FattureInCloud/model/PaymentMethodDetails
 * @version 2.0.1
 */
class PaymentMethodDetails {
    /**
     * Constructs a new <code>PaymentMethodDetails</code>.
     * @alias module:FattureInCloud/model/PaymentMethodDetails
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/PaymentMethodDetails} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/PaymentMethodDetails} The populated <code>PaymentMethodDetails</code> instance.
     */
