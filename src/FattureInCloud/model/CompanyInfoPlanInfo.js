 ...
 * @module FattureInCloud/model/CompanyInfoPlanInfo
 * @version 2.0.1
 */
class CompanyInfoPlanInfo {
    /**
     * Constructs a new <code>CompanyInfoPlanInfo</code>.
     * @alias module:FattureInCloud/model/CompanyInfoPlanInfo
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CompanyInfoPlanInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CompanyInfoPlanInfo} The populated <code>CompanyInfoPlanInfo</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/CompanyInfoPlanInfoLimits} limits
 */
CompanyInfoPlanInfo.prototype['limits'] = undefined;

/**
 * @member {module:FattureInCloud/model/CompanyInfoPlanInfoFunctions} functions
 */
CompanyInfoPlanInfo.prototype['functions'] = undefined;

/**
 * @member {module:FattureInCloud/model/CompanyInfoPlanInfoFunctionsStatus} functions_status
 */
