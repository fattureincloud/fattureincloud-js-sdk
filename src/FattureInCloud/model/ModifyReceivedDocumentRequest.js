 ...
 * @module FattureInCloud/model/ModifyReceivedDocumentRequest
 * @version 2.0.1
 */
class ModifyReceivedDocumentRequest {
     ...
     * Received document
     * @alias module:FattureInCloud/model/ModifyReceivedDocumentRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyReceivedDocumentRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyReceivedDocumentRequest} The populated <code>ModifyReceivedDocumentRequest</code> instance.
     */
