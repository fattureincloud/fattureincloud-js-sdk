 ...
 * @module FattureInCloud/model/GetNewIssuedDocumentTotalsResponse
 * @version 2.0.1
 */
class GetNewIssuedDocumentTotalsResponse {
     ...
     * Total
     * @alias module:FattureInCloud/model/GetNewIssuedDocumentTotalsResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetNewIssuedDocumentTotalsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetNewIssuedDocumentTotalsResponse} The populated <code>GetNewIssuedDocumentTotalsResponse</code> instance.
     */
