 ...
 * @module FattureInCloud/model/Currency
 * @version 2.0.1
 */
class Currency {
    /**
     ...
     * 
     * @alias module:FattureInCloud/model/Currency
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/Currency} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/Currency} The populated <code>Currency</code> instance.
     */
