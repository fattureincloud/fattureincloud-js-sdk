 ...
 * @module FattureInCloud/model/IssuedDocumentPreCreateInfoDefaultValues
 * @version 2.0.1
 */
class IssuedDocumentPreCreateInfoDefaultValues {
     ...
     * @alias module:FattureInCloud/model/IssuedDocumentPreCreateInfoDefaultValues
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentPreCreateInfoDefaultValues} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentPreCreateInfoDefaultValues} The populated <code>IssuedDocumentPreCreateInfoDefaultValues</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/DocumentTemplate} default_template
 */
IssuedDocumentPreCreateInfoDefaultValues.prototype['default_template'] = undefined;

/**
 * @member {module:FattureInCloud/model/DocumentTemplate} dn_template
 */
IssuedDocumentPreCreateInfoDefaultValues.prototype['dn_template'] = undefined;

/**
 * @member {module:FattureInCloud/model/DocumentTemplate} ai_template
 */
