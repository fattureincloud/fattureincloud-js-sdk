 ...
 * @module FattureInCloud/model/ListIssuedDocumentsResponsePage
 * @version 2.0.1
 */
class ListIssuedDocumentsResponsePage {
    /**
     * Constructs a new <code>ListIssuedDocumentsResponsePage</code>.
     * @alias module:FattureInCloud/model/ListIssuedDocumentsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListIssuedDocumentsResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListIssuedDocumentsResponsePage} The populated <code>ListIssuedDocumentsResponsePage</code> instance.
     */
