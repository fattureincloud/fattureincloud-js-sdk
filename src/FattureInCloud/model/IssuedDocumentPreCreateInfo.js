 ...
 * @module FattureInCloud/model/IssuedDocumentPreCreateInfo
 * @version 2.0.1
 */
class IssuedDocumentPreCreateInfo {
    /**
     * Constructs a new <code>IssuedDocumentPreCreateInfo</code>.
     * @alias module:FattureInCloud/model/IssuedDocumentPreCreateInfo
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentPreCreateInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentPreCreateInfo} The populated <code>IssuedDocumentPreCreateInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dn_numerations')) {
                obj['dn_numerations'] = ApiClient.convertToType(data['dn_numerations'], Object);
            }
 ...
 * @member {Object} dn_numerations
 */
IssuedDocumentPreCreateInfo.prototype['dn_numerations'] = undefined;

/**
 * @member {module:FattureInCloud/model/IssuedDocumentPreCreateInfoDefaultValues} default_values
 */
IssuedDocumentPreCreateInfo.prototype['default_values'] = undefined;

/**
 * @member {module:FattureInCloud/model/IssuedDocumentPreCreateInfoExtraDataDefaultValues} extra_data_default_values
 */
IssuedDocumentPreCreateInfo.prototype['extra_data_default_values'] = undefined;

/**
 * @member {module:FattureInCloud/model/IssuedDocumentPreCreateInfoItemsDefaultValues} items_default_values
 */
...
/**
 * Currencies list.
 * @member {Array.<module:FattureInCloud/model/Currency>} currencies_list
 */
IssuedDocumentPreCreateInfo.prototype['currencies_list'] = undefined;

/**
 * Document templates list.
 * @member {Array.<module:FattureInCloud/model/DocumentTemplate>} templates_list
 */
IssuedDocumentPreCreateInfo.prototype['templates_list'] = undefined;

/**
 * Delivery note templates list.
 * @member {Array.<module:FattureInCloud/model/DocumentTemplate>} dn_templates_list
 */
IssuedDocumentPreCreateInfo.prototype['dn_templates_list'] = undefined;

/**
 * Accompanying invoice templates list.
 * @member {Array.<module:FattureInCloud/model/DocumentTemplate>} ai_templates_list
 */
IssuedDocumentPreCreateInfo.prototype['ai_templates_list'] = undefined;

/**
 * Payment methods list.
 * @member {Array.<module:FattureInCloud/model/PaymentMethod>} payment_methods_list
 */
IssuedDocumentPreCreateInfo.prototype['payment_methods_list'] = undefined;

/**
 * Payment accounts list.
 * @member {Array.<module:FattureInCloud/model/PaymentAccount>} payment_accounts_list
 */
IssuedDocumentPreCreateInfo.prototype['payment_accounts_list'] = undefined;

/**
 * Vat types list.
 * @member {Array.<module:FattureInCloud/model/VatType>} vat_types_list
 */
