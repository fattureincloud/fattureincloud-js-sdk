 ...
 * @module FattureInCloud/model/ReceivedDocumentInfoItemsDefaultValues
 * @version 2.0.1
 */
class ReceivedDocumentInfoItemsDefaultValues {
     ...
     * @alias module:FattureInCloud/model/ReceivedDocumentInfoItemsDefaultValues
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocumentInfoItemsDefaultValues} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocumentInfoItemsDefaultValues} The populated <code>ReceivedDocumentInfoItemsDefaultValues</code> instance.
     */
