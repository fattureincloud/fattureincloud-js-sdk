 ...
 * @module FattureInCloud/model/ListTemplatesResponse
 * @version 2.0.1
 */
class ListTemplatesResponse {
     ...
     * Templates list.
     * @alias module:FattureInCloud/model/ListTemplatesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListTemplatesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListTemplatesResponse} The populated <code>ListTemplatesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/DocumentTemplate>} data
 */
