 ...
 * @module FattureInCloud/model/ModifyArchiveDocumentRequest
 * @version 2.0.1
 */
class ModifyArchiveDocumentRequest {
     ...
     * Archive Document.
     * @alias module:FattureInCloud/model/ModifyArchiveDocumentRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyArchiveDocumentRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyArchiveDocumentRequest} The populated <code>ModifyArchiveDocumentRequest</code> instance.
     */
