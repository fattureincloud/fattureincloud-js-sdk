 ...
 * @module FattureInCloud/model/CreateProductRequest
 * @version 2.0.1
 */
class CreateProductRequest {
    /**
     * Constructs a new <code>CreateProductRequest</code>.
     * @alias module:FattureInCloud/model/CreateProductRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateProductRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateProductRequest} The populated <code>CreateProductRequest</code> instance.
     */
