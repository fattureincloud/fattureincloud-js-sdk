 ...
 * @module FattureInCloud/model/SendEInvoiceResponse
 * @version 2.0.1
 */
class SendEInvoiceResponse {
    /**
     * Constructs a new <code>SendEInvoiceResponse</code>.
     * @alias module:FattureInCloud/model/SendEInvoiceResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/SendEInvoiceResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/SendEInvoiceResponse} The populated <code>SendEInvoiceResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/SendEInvoiceResponseData} data
 */
