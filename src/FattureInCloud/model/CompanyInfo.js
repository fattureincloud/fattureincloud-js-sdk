 ...
 * @module FattureInCloud/model/CompanyInfo
 * @version 2.0.1
 */
class CompanyInfo {
    /**
     ...
     * @alias module:FattureInCloud/model/CompanyInfo
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CompanyInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CompanyInfo} The populated <code>CompanyInfo</code> instance.
     */
...
/**
 * Company type.
 * @member {module:FattureInCloud/model/CompanyInfo.TypeEnum} type
 */
 ...
 * @member {module:FattureInCloud/model/CompanyInfo.FicPlanNameEnum} fic_plan_name
 */
 ...
 * @member {module:FattureInCloud/model/CompanyInfo.DicPlanEnum} dic_plan
 */
...
/**
 * @member {module:FattureInCloud/model/CompanyInfoAccessInfo} access_info
 */
CompanyInfo.prototype['access_info'] = undefined;

/**
 * @member {module:FattureInCloud/model/CompanyInfoPlanInfo} plan_info
 */
