 ...
 * @module FattureInCloud/model/CashbookEntryInData
 * @version 2.0.1
 */
class CashbookEntryInData {
    /**
     * Constructs a new <code>CashbookEntryInData</code>.
     * @alias module:FattureInCloud/model/CashbookEntryInData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CashbookEntryInData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CashbookEntryInData} The populated <code>CashbookEntryInData</code> instance.
     */
