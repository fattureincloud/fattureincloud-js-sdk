 ...
 * @module FattureInCloud/model/IssuedDocumentEiData
 * @version 2.0.1
 */
class IssuedDocumentEiData {
     ...
     * @alias module:FattureInCloud/model/IssuedDocumentEiData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentEiData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentEiData} The populated <code>IssuedDocumentEiData</code> instance.
     */
 ...
 * @member {module:FattureInCloud/model/IssuedDocumentEiData.VatKindEnum} vat_kind
 */
IssuedDocumentEiData.prototype['vat_kind'] = undefined;

/**
 * Type of document followed by the the current invoice.
 * @member {module:FattureInCloud/model/IssuedDocumentEiData.OriginalDocumentTypeEnum} original_document_type
 * @default 'ordine'
 */
