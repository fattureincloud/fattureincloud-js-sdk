 ...
 * @module FattureInCloud/model/ModifyArchiveDocumentResponse
 * @version 2.0.1
 */
class ModifyArchiveDocumentResponse {
    /**
     * Constructs a new <code>ModifyArchiveDocumentResponse</code>.
     * The modified Archive Document
     * @alias module:FattureInCloud/model/ModifyArchiveDocumentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyArchiveDocumentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyArchiveDocumentResponse} The populated <code>ModifyArchiveDocumentResponse</code> instance.
     */
