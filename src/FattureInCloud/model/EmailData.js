 ...
 * @module FattureInCloud/model/EmailData
 * @version 2.0.1
 */
class EmailData {
    /**
     ...
     * Email
     * @alias module:FattureInCloud/model/EmailData
     * @param recipientEmail {String} Recipient's email
     * @param defaultSenderEmail {module:FattureInCloud/model/EmailDataDefaultSenderEmail} 
     * @param senderEmailsList {Array.<module:FattureInCloud/model/EmailDataSenderEmailsList>} List of all emails from which the document can be sent
     ...
     * @param {module:FattureInCloud/model/EmailData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/EmailData} The populated <code>EmailData</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/EmailDataDefaultSenderEmail} default_sender_email
 */
EmailData.prototype['default_sender_email'] = undefined;

/**
 * List of all emails from which the document can be sent
 * @member {Array.<module:FattureInCloud/model/EmailDataSenderEmailsList>} sender_emails_list
 */
