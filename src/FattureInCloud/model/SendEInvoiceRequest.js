 ...
 * @module FattureInCloud/model/SendEInvoiceRequest
 * @version 2.0.1
 */
class SendEInvoiceRequest {
    /**
     * Constructs a new <code>SendEInvoiceRequest</code>.
     * @alias module:FattureInCloud/model/SendEInvoiceRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/SendEInvoiceRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/SendEInvoiceRequest} The populated <code>SendEInvoiceRequest</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/SendEInvoiceRequestData} data
 */
