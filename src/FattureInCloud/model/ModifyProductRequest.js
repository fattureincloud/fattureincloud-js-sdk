 ...
 * @module FattureInCloud/model/ModifyProductRequest
 * @version 2.0.1
 */
class ModifyProductRequest {
    /**
     * Constructs a new <code>ModifyProductRequest</code>.
     * @alias module:FattureInCloud/model/ModifyProductRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyProductRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyProductRequest} The populated <code>ModifyProductRequest</code> instance.
     */
