 ...
 * @module FattureInCloud/model/CreatePaymentAccountRequest
 * @version 2.0.1
 */
class CreatePaymentAccountRequest {
    /**
     * Constructs a new <code>CreatePaymentAccountRequest</code>.
     * @alias module:FattureInCloud/model/CreatePaymentAccountRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreatePaymentAccountRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreatePaymentAccountRequest} The populated <code>CreatePaymentAccountRequest</code> instance.
     */
