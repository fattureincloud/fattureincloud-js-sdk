 ...
 * @module FattureInCloud/model/ListUnitsOfMeasureResponse
 * @version 2.0.1
 */
class ListUnitsOfMeasureResponse {
     ...
     * Units of measure.
     * @alias module:FattureInCloud/model/ListUnitsOfMeasureResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListUnitsOfMeasureResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListUnitsOfMeasureResponse} The populated <code>ListUnitsOfMeasureResponse</code> instance.
     */
