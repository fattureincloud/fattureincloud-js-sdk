 ...
 * @module FattureInCloud/model/ListCostCentersResponse
 * @version 2.0.1
 */
class ListCostCentersResponse {
    /**
     * Constructs a new <code>ListCostCentersResponse</code>.
     * @alias module:FattureInCloud/model/ListCostCentersResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListCostCentersResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListCostCentersResponse} The populated <code>ListCostCentersResponse</code> instance.
     */
