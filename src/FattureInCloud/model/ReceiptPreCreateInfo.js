 ...
 * @module FattureInCloud/model/ReceiptPreCreateInfo
 * @version 2.0.1
 */
class ReceiptPreCreateInfo {
     ...
     * Pre-create info.
     * @alias module:FattureInCloud/model/ReceiptPreCreateInfo
     ...
     * @param paymentAccountsList {Array.<module:FattureInCloud/model/PaymentAccount>} User payment accounts list.
     * @param categoriesList {Array.<String>} List of categories used in the past.
     * @param vatTypesList {Array.<module:FattureInCloud/model/VatType>} List of user vat types with the default 22%, 10%, 4% and 0% vats.
     */
     ...
     * @param {module:FattureInCloud/model/ReceiptPreCreateInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceiptPreCreateInfo} The populated <code>ReceiptPreCreateInfo</code> instance.
     */
