 ...
 * @module FattureInCloud/model/CreatePaymentMethodResponse
 * @version 2.0.1
 */
class CreatePaymentMethodResponse {
    /**
     * Constructs a new <code>CreatePaymentMethodResponse</code>.
     * @alias module:FattureInCloud/model/CreatePaymentMethodResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreatePaymentMethodResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreatePaymentMethodResponse} The populated <code>CreatePaymentMethodResponse</code> instance.
     */
