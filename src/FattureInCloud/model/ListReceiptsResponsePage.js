 ...
 * @module FattureInCloud/model/ListReceiptsResponsePage
 * @version 2.0.1
 */
class ListReceiptsResponsePage {
    /**
     * Constructs a new <code>ListReceiptsResponsePage</code>.
     * @alias module:FattureInCloud/model/ListReceiptsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListReceiptsResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListReceiptsResponsePage} The populated <code>ListReceiptsResponsePage</code> instance.
     */
