 ...
 * @module FattureInCloud/model/VerifyEInvoiceXmlErrorResponse
 * @version 2.0.1
 */
class VerifyEInvoiceXmlErrorResponse {
    /**
     * Constructs a new <code>VerifyEInvoiceXmlErrorResponse</code>.
     * @alias module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponse} The populated <code>VerifyEInvoiceXmlErrorResponse</code> instance.
     */
