 ...
 * @module FattureInCloud/model/ListArchiveDocumentsResponsePage
 * @version 2.0.1
 */
class ListArchiveDocumentsResponsePage {
    /**
     * Constructs a new <code>ListArchiveDocumentsResponsePage</code>.
     * @alias module:FattureInCloud/model/ListArchiveDocumentsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListArchiveDocumentsResponsePage} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListArchiveDocumentsResponsePage} The populated <code>ListArchiveDocumentsResponsePage</code> instance.
     */
