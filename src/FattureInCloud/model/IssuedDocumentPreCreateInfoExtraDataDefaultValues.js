 ...
 * @module FattureInCloud/model/IssuedDocumentPreCreateInfoExtraDataDefaultValues
 * @version 2.0.1
 */
class IssuedDocumentPreCreateInfoExtraDataDefaultValues {
     ...
     * @alias module:FattureInCloud/model/IssuedDocumentPreCreateInfoExtraDataDefaultValues
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentPreCreateInfoExtraDataDefaultValues} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentPreCreateInfoExtraDataDefaultValues} The populated <code>IssuedDocumentPreCreateInfoExtraDataDefaultValues</code> instance.
     */
