 ...
 * @module FattureInCloud/model/ModifyProductResponse
 * @version 2.0.1
 */
class ModifyProductResponse {
    /**
     * Constructs a new <code>ModifyProductResponse</code>.
     * @alias module:FattureInCloud/model/ModifyProductResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyProductResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyProductResponse} The populated <code>ModifyProductResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/Product} data
 */
