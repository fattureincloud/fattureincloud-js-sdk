 ...
 * @module FattureInCloud/model/ListRevenueCentersResponse
 * @version 2.0.1
 */
class ListRevenueCentersResponse {
     ...
     * @alias module:FattureInCloud/model/ListRevenueCentersResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListRevenueCentersResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListRevenueCentersResponse} The populated <code>ListRevenueCentersResponse</code> instance.
     */
