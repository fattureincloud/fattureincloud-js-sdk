 ...
 * @module FattureInCloud/model/GetExistingIssuedDocumentTotalsResponse
 * @version 2.0.1
 */
class GetExistingIssuedDocumentTotalsResponse {
     ...
     * Total
     * @alias module:FattureInCloud/model/GetExistingIssuedDocumentTotalsResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetExistingIssuedDocumentTotalsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetExistingIssuedDocumentTotalsResponse} The populated <code>GetExistingIssuedDocumentTotalsResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/IssuedDocumentTotals} data
 */
