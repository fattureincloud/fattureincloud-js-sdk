 ...
 * @module FattureInCloud/model/GetEmailDataResponse
 * @version 2.0.1
 */
class GetEmailDataResponse {
    /**
     * Constructs a new <code>GetEmailDataResponse</code>.
     * @alias module:FattureInCloud/model/GetEmailDataResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetEmailDataResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetEmailDataResponse} The populated <code>GetEmailDataResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/EmailData} data
 */
