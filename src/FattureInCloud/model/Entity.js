 ...
 * @module FattureInCloud/model/Entity
 * @version 2.0.1
 */
class Entity {
    /**
     * Constructs a new <code>Entity</code>.
     * @alias module:FattureInCloud/model/Entity
     * @implements module:FattureInCloud/model/Client
     * @implements module:FattureInCloud/model/Supplier
     ...
     * @param {module:FattureInCloud/model/Entity} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/Entity} The populated <code>Entity</code> instance.
     */
...
/**
 * Supplier type.
 * @member {module:FattureInCloud/model/Entity.TypeEnum} type
 */
...
/**
 * @member {module:FattureInCloud/model/VatType} default_vat
 */
...
/**
 * @member {module:FattureInCloud/model/Entity.DefaultPaymentTermsTypeEnum} default_payment_terms_type
 * @default 'standard'
 */
Entity.prototype['default_payment_terms_type'] = 'standard';

/**
 * @member {module:FattureInCloud/model/PaymentMethod} default_payment_method
 */
...
/**
 * Client type
 * @member {module:FattureInCloud/model/Client.TypeEnum} type
 */
...
/**
 * @member {module:FattureInCloud/model/Client.DefaultPaymentTermsTypeEnum} default_payment_terms_type
 * @default 'standard'
 */
...
/**
 * Supplier type.
 * @member {module:FattureInCloud/model/Supplier.TypeEnum} type
 */
