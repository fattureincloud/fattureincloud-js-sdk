 ...
 * @module FattureInCloud/model/UploadArchiveAttachmentResponse
 * @version 2.0.1
 */
class UploadArchiveAttachmentResponse {
    /**
     * Constructs a new <code>UploadArchiveAttachmentResponse</code>.
     * @alias module:FattureInCloud/model/UploadArchiveAttachmentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/UploadArchiveAttachmentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/UploadArchiveAttachmentResponse} The populated <code>UploadArchiveAttachmentResponse</code> instance.
     */
