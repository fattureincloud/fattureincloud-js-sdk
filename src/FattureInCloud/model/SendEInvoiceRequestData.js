 ...
 * @module FattureInCloud/model/SendEInvoiceRequestData
 * @version 2.0.1
 */
class SendEInvoiceRequestData {
    /**
     * Constructs a new <code>SendEInvoiceRequestData</code>.
     * @alias module:FattureInCloud/model/SendEInvoiceRequestData
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/SendEInvoiceRequestData} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/SendEInvoiceRequestData} The populated <code>SendEInvoiceRequestData</code> instance.
     */
