 ...
 * @module FattureInCloud/model/FunctionStatus
 * @version 2.0.1
 */
class FunctionStatus {
    /**
     * Constructs a new <code>FunctionStatus</code>.
     * @alias module:FattureInCloud/model/FunctionStatus
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/FunctionStatus} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/FunctionStatus} The populated <code>FunctionStatus</code> instance.
     */
