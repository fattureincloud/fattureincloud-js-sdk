 ...
 * @module FattureInCloud/model/CashbookEntryOut
 * @version 2.0.1
 */
class CashbookEntryOut {
    /**
     * Constructs a new <code>CashbookEntryOut</code>.
     * @alias module:FattureInCloud/model/CashbookEntryOut
     * @implements module:FattureInCloud/model/CashbookEntryData
     * @implements module:FattureInCloud/model/CashbookEntryOutData
     * @param id {String} Cashbook unique identifier.
     * @param date {Date} Cashbook date.
     * @param description {String} Cashbook description.
     * @param kind {module:FattureInCloud/model/CashbookEntryOut.KindEnum} Cashbook kind.
     * @param type {module:FattureInCloud/model/CashbookEntryOut.TypeEnum} Cashbook type.
     */
     ...
     * @param {module:FattureInCloud/model/CashbookEntryOut} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CashbookEntryOut} The populated <code>CashbookEntryOut</code> instance.
     */
...
/**
 * Cashbook kind.
 * @member {module:FattureInCloud/model/CashbookEntryData.KindEnum} kind
 */
CashbookEntryData.prototype['kind'] = undefined;
/**
 * Cashbook type.
 * @member {module:FattureInCloud/model/CashbookEntryData.TypeEnum} type
 */
