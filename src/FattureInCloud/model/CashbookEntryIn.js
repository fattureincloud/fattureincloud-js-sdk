 ...
 * @module FattureInCloud/model/CashbookEntryIn
 * @version 2.0.1
 */
class CashbookEntryIn {
    /**
     * Constructs a new <code>CashbookEntryIn</code>.
     * @alias module:FattureInCloud/model/CashbookEntryIn
     * @implements module:FattureInCloud/model/CashbookEntryData
     * @implements module:FattureInCloud/model/CashbookEntryInData
     * @param id {String} Cashbook unique identifier.
     * @param date {Date} Cashbook date.
     * @param description {String} Cashbook description.
     * @param kind {module:FattureInCloud/model/CashbookEntryIn.KindEnum} Cashbook kind.
     * @param type {module:FattureInCloud/model/CashbookEntryIn.TypeEnum} Cashbook type.
     */
     ...
     * @param {module:FattureInCloud/model/CashbookEntryIn} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CashbookEntryIn} The populated <code>CashbookEntryIn</code> instance.
     */
