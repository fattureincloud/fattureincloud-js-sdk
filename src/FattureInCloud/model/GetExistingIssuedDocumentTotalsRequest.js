 ...
 * @module FattureInCloud/model/GetExistingIssuedDocumentTotalsRequest
 * @version 2.0.1
 */
class GetExistingIssuedDocumentTotalsRequest {
    /**
     * Constructs a new <code>GetExistingIssuedDocumentTotalsRequest</code>.
     * @alias module:FattureInCloud/model/GetExistingIssuedDocumentTotalsRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetExistingIssuedDocumentTotalsRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetExistingIssuedDocumentTotalsRequest} The populated <code>GetExistingIssuedDocumentTotalsRequest</code> instance.
     */
