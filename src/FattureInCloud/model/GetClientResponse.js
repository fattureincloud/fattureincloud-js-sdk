 ...
 * @module FattureInCloud/model/GetClientResponse
 * @version 2.0.1
 */
class GetClientResponse {
    /**
     * Constructs a new <code>GetClientResponse</code>.
     * @alias module:FattureInCloud/model/GetClientResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetClientResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetClientResponse} The populated <code>GetClientResponse</code> instance.
     */
