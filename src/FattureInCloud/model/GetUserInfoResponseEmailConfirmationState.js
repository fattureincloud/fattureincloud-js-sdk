 ...
 * @module FattureInCloud/model/GetUserInfoResponseEmailConfirmationState
 * @version 2.0.1
 */
class GetUserInfoResponseEmailConfirmationState {
    /**
     * Constructs a new <code>GetUserInfoResponseEmailConfirmationState</code>.
     * @alias module:FattureInCloud/model/GetUserInfoResponseEmailConfirmationState
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetUserInfoResponseEmailConfirmationState} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetUserInfoResponseEmailConfirmationState} The populated <code>GetUserInfoResponseEmailConfirmationState</code> instance.
     */
