 ...
 * @module FattureInCloud/model/EmailDataSenderEmailsList
 * @version 2.0.1
 */
class EmailDataSenderEmailsList {
    /**
     * Constructs a new <code>EmailDataSenderEmailsList</code>.
     * @alias module:FattureInCloud/model/EmailDataSenderEmailsList
     * @param id {Number} Id
     ...
     * @param {module:FattureInCloud/model/EmailDataSenderEmailsList} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/EmailDataSenderEmailsList} The populated <code>EmailDataSenderEmailsList</code> instance.
     */
