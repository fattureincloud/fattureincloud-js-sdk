 ...
 * @module FattureInCloud/model/ReceivedDocumentPaymentsList
 * @version 2.0.1
 */
class ReceivedDocumentPaymentsList {
    /**
     * Constructs a new <code>ReceivedDocumentPaymentsList</code>.
     * @alias module:FattureInCloud/model/ReceivedDocumentPaymentsList
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocumentPaymentsList} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocumentPaymentsList} The populated <code>ReceivedDocumentPaymentsList</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/ReceivedDocumentPaymentTerms} payment_terms
 */
