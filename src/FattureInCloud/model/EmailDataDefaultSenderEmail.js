 ...
 * @module FattureInCloud/model/EmailDataDefaultSenderEmail
 * @version 2.0.1
 */
class EmailDataDefaultSenderEmail {
     ...
     * @alias module:FattureInCloud/model/EmailDataDefaultSenderEmail
     * @param id {Number} Id
     ...
     * @param {module:FattureInCloud/model/EmailDataDefaultSenderEmail} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/EmailDataDefaultSenderEmail} The populated <code>EmailDataDefaultSenderEmail</code> instance.
     */
