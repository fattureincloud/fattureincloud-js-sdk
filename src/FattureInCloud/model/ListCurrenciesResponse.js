 ...
 * @module FattureInCloud/model/ListCurrenciesResponse
 * @version 2.0.1
 */
class ListCurrenciesResponse {
     ...
     * Currencies List.
     * @alias module:FattureInCloud/model/ListCurrenciesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListCurrenciesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListCurrenciesResponse} The populated <code>ListCurrenciesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/Currency>} data
 */
