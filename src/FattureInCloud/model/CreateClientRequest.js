 ...
 * @module FattureInCloud/model/CreateClientRequest
 * @version 2.0.1
 */
class CreateClientRequest {
    /**
     * Constructs a new <code>CreateClientRequest</code>.
     * @alias module:FattureInCloud/model/CreateClientRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateClientRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateClientRequest} The populated <code>CreateClientRequest</code> instance.
     */
