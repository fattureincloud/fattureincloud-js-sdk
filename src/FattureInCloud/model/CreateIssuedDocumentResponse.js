 ...
 * @module FattureInCloud/model/CreateIssuedDocumentResponse
 * @version 2.0.1
 */
class CreateIssuedDocumentResponse {
    /**
     * Constructs a new <code>CreateIssuedDocumentResponse</code>.
     * @alias module:FattureInCloud/model/CreateIssuedDocumentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateIssuedDocumentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateIssuedDocumentResponse} The populated <code>CreateIssuedDocumentResponse</code> instance.
     */
