 ...
 * @module FattureInCloud/model/ListVatTypesResponse
 * @version 2.0.1
 */
class ListVatTypesResponse {
     ...
     * Vat Types List
     * @alias module:FattureInCloud/model/ListVatTypesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListVatTypesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListVatTypesResponse} The populated <code>ListVatTypesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/VatType>} data
 */
