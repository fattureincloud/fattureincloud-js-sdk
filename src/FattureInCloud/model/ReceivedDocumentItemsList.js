 ...
 * @module FattureInCloud/model/ReceivedDocumentItemsList
 * @version 2.0.1
 */
class ReceivedDocumentItemsList {
    /**
     * Constructs a new <code>ReceivedDocumentItemsList</code>.
     * @alias module:FattureInCloud/model/ReceivedDocumentItemsList
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocumentItemsList} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocumentItemsList} The populated <code>ReceivedDocumentItemsList</code> instance.
     */
