 ...
 * @module FattureInCloud/model/UploadIssuedDocumentAttachmentResponse
 * @version 2.0.1
 */
class UploadIssuedDocumentAttachmentResponse {
     ...
     * Attachment Token.
     * @alias module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponse} The populated <code>UploadIssuedDocumentAttachmentResponse</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/UploadIssuedDocumentAttachmentResponseData} data
 */
