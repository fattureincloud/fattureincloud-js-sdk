 ...
 * @module FattureInCloud/model/CompanyInfoAccessInfo
 * @version 2.0.1
 */
class CompanyInfoAccessInfo {
    /**
     * Constructs a new <code>CompanyInfoAccessInfo</code>.
     * @alias module:FattureInCloud/model/CompanyInfoAccessInfo
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CompanyInfoAccessInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CompanyInfoAccessInfo} The populated <code>CompanyInfoAccessInfo</code> instance.
     */
 ...
 * @member {module:FattureInCloud/model/CompanyInfoAccessInfo.RoleEnum} role
 */
