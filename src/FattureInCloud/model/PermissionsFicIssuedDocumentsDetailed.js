 ...
 * @module FattureInCloud/model/PermissionsFicIssuedDocumentsDetailed
 * @version 2.0.1
 */
class PermissionsFicIssuedDocumentsDetailed {
    /**
     * Constructs a new <code>PermissionsFicIssuedDocumentsDetailed</code>.
     * @alias module:FattureInCloud/model/PermissionsFicIssuedDocumentsDetailed
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/PermissionsFicIssuedDocumentsDetailed} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/PermissionsFicIssuedDocumentsDetailed} The populated <code>PermissionsFicIssuedDocumentsDetailed</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/PermissionLevel} quotes
 */
PermissionsFicIssuedDocumentsDetailed.prototype['quotes'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} proformas
 */
PermissionsFicIssuedDocumentsDetailed.prototype['proformas'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} invoices
 */
PermissionsFicIssuedDocumentsDetailed.prototype['invoices'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} receipts
 */
PermissionsFicIssuedDocumentsDetailed.prototype['receipts'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} delivery_notes
 */
PermissionsFicIssuedDocumentsDetailed.prototype['delivery_notes'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} credit_notes
 */
PermissionsFicIssuedDocumentsDetailed.prototype['credit_notes'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} orders
 */
PermissionsFicIssuedDocumentsDetailed.prototype['orders'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} work_reports
 */
PermissionsFicIssuedDocumentsDetailed.prototype['work_reports'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} supplier_orders
 */
PermissionsFicIssuedDocumentsDetailed.prototype['supplier_orders'] = undefined;

/**
 * @member {module:FattureInCloud/model/PermissionLevel} self_invoices
 */
