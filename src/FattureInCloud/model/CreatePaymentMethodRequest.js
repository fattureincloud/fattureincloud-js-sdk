 ...
 * @module FattureInCloud/model/CreatePaymentMethodRequest
 * @version 2.0.1
 */
class CreatePaymentMethodRequest {
    /**
     * Constructs a new <code>CreatePaymentMethodRequest</code>.
     * @alias module:FattureInCloud/model/CreatePaymentMethodRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreatePaymentMethodRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreatePaymentMethodRequest} The populated <code>CreatePaymentMethodRequest</code> instance.
     */
