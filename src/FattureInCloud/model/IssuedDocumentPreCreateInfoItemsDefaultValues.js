 ...
 * @module FattureInCloud/model/IssuedDocumentPreCreateInfoItemsDefaultValues
 * @version 2.0.1
 */
class IssuedDocumentPreCreateInfoItemsDefaultValues {
     ...
     * @alias module:FattureInCloud/model/IssuedDocumentPreCreateInfoItemsDefaultValues
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/IssuedDocumentPreCreateInfoItemsDefaultValues} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/IssuedDocumentPreCreateInfoItemsDefaultValues} The populated <code>IssuedDocumentPreCreateInfoItemsDefaultValues</code> instance.
     */
