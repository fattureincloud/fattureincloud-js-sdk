 ...
 * @module FattureInCloud/model/ModifySupplierResponse
 * @version 2.0.1
 */
class ModifySupplierResponse {
    /**
     * Constructs a new <code>ModifySupplierResponse</code>.
     * @alias module:FattureInCloud/model/ModifySupplierResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifySupplierResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifySupplierResponse} The populated <code>ModifySupplierResponse</code> instance.
     */
