 ...
 * @module FattureInCloud/model/ModifyPaymentMethodRequest
 * @version 2.0.1
 */
class ModifyPaymentMethodRequest {
    /**
     * Constructs a new <code>ModifyPaymentMethodRequest</code>.
     * @alias module:FattureInCloud/model/ModifyPaymentMethodRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ModifyPaymentMethodRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ModifyPaymentMethodRequest} The populated <code>ModifyPaymentMethodRequest</code> instance.
     */
