 ...
 * @module FattureInCloud/model/CompanyInfoPlanInfoFunctionsStatus
 * @version 2.0.1
 */
class CompanyInfoPlanInfoFunctionsStatus {
    /**
     * Constructs a new <code>CompanyInfoPlanInfoFunctionsStatus</code>.
     * @alias module:FattureInCloud/model/CompanyInfoPlanInfoFunctionsStatus
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CompanyInfoPlanInfoFunctionsStatus} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CompanyInfoPlanInfoFunctionsStatus} The populated <code>CompanyInfoPlanInfoFunctionsStatus</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/FunctionStatus} ts_digital
 */
CompanyInfoPlanInfoFunctionsStatus.prototype['ts_digital'] = undefined;

/**
 * @member {module:FattureInCloud/model/FunctionStatus} ts_pay
 */
