 ...
 * @module FattureInCloud/model/GetUserInfoResponseInfo
 * @version 2.0.1
 */
class GetUserInfoResponseInfo {
    /**
     * Constructs a new <code>GetUserInfoResponseInfo</code>.
     * @alias module:FattureInCloud/model/GetUserInfoResponseInfo
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetUserInfoResponseInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetUserInfoResponseInfo} The populated <code>GetUserInfoResponseInfo</code> instance.
     */
