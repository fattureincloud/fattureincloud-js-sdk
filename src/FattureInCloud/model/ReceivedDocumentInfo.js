 ...
 * @module FattureInCloud/model/ReceivedDocumentInfo
 * @version 2.0.1
 */
class ReceivedDocumentInfo {
     ...
     * 
     * @alias module:FattureInCloud/model/ReceivedDocumentInfo
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ReceivedDocumentInfo} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ReceivedDocumentInfo} The populated <code>ReceivedDocumentInfo</code> instance.
     */
...
/**
 * @member {module:FattureInCloud/model/ReceivedDocumentInfoDefaultValues} default_values
 */
ReceivedDocumentInfo.prototype['default_values'] = undefined;

/**
 * @member {module:FattureInCloud/model/ReceivedDocumentInfoItemsDefaultValues} items_default_values
 */
