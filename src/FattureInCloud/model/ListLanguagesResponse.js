 ...
 * @module FattureInCloud/model/ListLanguagesResponse
 * @version 2.0.1
 */
class ListLanguagesResponse {
     ...
     * Languages list.
     * @alias module:FattureInCloud/model/ListLanguagesResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListLanguagesResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListLanguagesResponse} The populated <code>ListLanguagesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/Language>} data
 */
