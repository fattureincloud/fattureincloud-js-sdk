 ...
 * @module FattureInCloud/model/CashbookEntry
 * @version 2.0.1
 */
class CashbookEntry {
    /**
     * Constructs a new <code>CashbookEntry</code>.
     * @alias module:FattureInCloud/model/CashbookEntry
     ...
     * @param kind {module:FattureInCloud/model/CashbookEntry.KindEnum} Cashbook kind.
     * @param type {module:FattureInCloud/model/CashbookEntry.TypeEnum} Cashbook type.
     */
     ...
     * @param {module:FattureInCloud/model/CashbookEntry} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CashbookEntry} The populated <code>CashbookEntry</code> instance.
     */
...
/**
 * Cashbook kind.
 * @member {module:FattureInCloud/model/CashbookEntry.KindEnum} kind
 */
CashbookEntry.prototype['kind'] = undefined;

/**
 * Cashbook type.
 * @member {module:FattureInCloud/model/CashbookEntry.TypeEnum} type
 */
