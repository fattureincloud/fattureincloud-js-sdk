 ...
 * @module FattureInCloud/model/VerifyEInvoiceXmlErrorResponseExtra
 * @version 2.0.1
 */
class VerifyEInvoiceXmlErrorResponseExtra {
    /**
     * Constructs a new <code>VerifyEInvoiceXmlErrorResponseExtra</code>.
     * @alias module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponseExtra
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponseExtra} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/VerifyEInvoiceXmlErrorResponseExtra} The populated <code>VerifyEInvoiceXmlErrorResponseExtra</code> instance.
     */
