 ...
 * @module FattureInCloud/model/CompanyInfoPlanInfoFunctions
 * @version 2.0.1
 */
class CompanyInfoPlanInfoFunctions {
     ...
     * @alias module:FattureInCloud/model/CompanyInfoPlanInfoFunctions
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CompanyInfoPlanInfoFunctions} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CompanyInfoPlanInfoFunctions} The populated <code>CompanyInfoPlanInfoFunctions</code> instance.
     */
