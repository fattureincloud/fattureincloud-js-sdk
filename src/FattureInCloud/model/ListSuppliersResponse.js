 ...
 * @module FattureInCloud/model/ListSuppliersResponse
 * @version 2.0.1
 */
class ListSuppliersResponse {
    /**
     * Constructs a new <code>ListSuppliersResponse</code>.
     * @alias module:FattureInCloud/model/ListSuppliersResponse
     * @implements module:FattureInCloud/model/Pagination
     * @implements module:FattureInCloud/model/ListSuppliersResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListSuppliersResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListSuppliersResponse} The populated <code>ListSuppliersResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/Supplier>} data
 */
