 ...
 * @module FattureInCloud/model/GetNewReceivedDocumentTotalsRequest
 * @version 2.0.1
 */
class GetNewReceivedDocumentTotalsRequest {
     ...
     * Document.
     * @alias module:FattureInCloud/model/GetNewReceivedDocumentTotalsRequest
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetNewReceivedDocumentTotalsRequest} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetNewReceivedDocumentTotalsRequest} The populated <code>GetNewReceivedDocumentTotalsRequest</code> instance.
     */
