 ...
 * @module FattureInCloud/model/DocumentTemplate
 * @version 2.0.1
 */
class DocumentTemplate {
    /**
     * Constructs a new <code>DocumentTemplate</code>.
     * @alias module:FattureInCloud/model/DocumentTemplate
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/DocumentTemplate} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/DocumentTemplate} The populated <code>DocumentTemplate</code> instance.
     */
