 ...
 * @module FattureInCloud/model/ListIssuedDocumentsResponse
 * @version 2.0.1
 */
class ListIssuedDocumentsResponse {
    /**
     * Constructs a new <code>ListIssuedDocumentsResponse</code>.
     * @alias module:FattureInCloud/model/ListIssuedDocumentsResponse
     * @implements module:FattureInCloud/model/Pagination
     * @implements module:FattureInCloud/model/ListIssuedDocumentsResponsePage
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/ListIssuedDocumentsResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/ListIssuedDocumentsResponse} The populated <code>ListIssuedDocumentsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:FattureInCloud/model/IssuedDocument>} data
 */
