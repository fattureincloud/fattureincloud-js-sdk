 ...
 * @module FattureInCloud/model/GetIssuedDocumentResponse
 * @version 2.0.1
 */
class GetIssuedDocumentResponse {
    /**
     * Constructs a new <code>GetIssuedDocumentResponse</code>.
     * @alias module:FattureInCloud/model/GetIssuedDocumentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetIssuedDocumentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetIssuedDocumentResponse} The populated <code>GetIssuedDocumentResponse</code> instance.
     */
