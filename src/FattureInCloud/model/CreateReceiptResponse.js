 ...
 * @module FattureInCloud/model/CreateReceiptResponse
 * @version 2.0.1
 */
class CreateReceiptResponse {
     ...
     * Created Receipt.
     * @alias module:FattureInCloud/model/CreateReceiptResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/CreateReceiptResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/CreateReceiptResponse} The populated <code>CreateReceiptResponse</code> instance.
     */
