 ...
 * @module FattureInCloud/model/GetArchiveDocumentResponse
 * @version 2.0.1
 */
class GetArchiveDocumentResponse {
     ...
     * Archive Document
     * @alias module:FattureInCloud/model/GetArchiveDocumentResponse
     */
    constructor() { 
     ...
     * @param {module:FattureInCloud/model/GetArchiveDocumentResponse} obj Optional instance to populate.
     * @return {module:FattureInCloud/model/GetArchiveDocumentResponse} The populated <code>GetArchiveDocumentResponse</code> instance.
     */
