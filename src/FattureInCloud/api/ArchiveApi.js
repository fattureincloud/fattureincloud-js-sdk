...
/**
* Archive service.
* @module FattureInCloud/api/ArchiveApi
* @version 2.0.1
*/
export default class ArchiveApi {
    ...
    * @alias module:FattureInCloud/api/ArchiveApi
    * @class
    ...
    */
     ...
     * @callback module:FattureInCloud/api/ArchiveApi~createArchiveDocumentCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/CreateArchiveDocumentResponse} data The data returned by the service call.
     ...
     * @param {module:FattureInCloud/model/CreateArchiveDocumentRequest} opts.createArchiveDocumentRequest The Archive Document.
     * @param {module:FattureInCloud/api/ArchiveApi~createArchiveDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/CreateArchiveDocumentResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ArchiveApi~deleteArchiveDocumentCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:FattureInCloud/api/ArchiveApi~deleteArchiveDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:FattureInCloud/api/ArchiveApi~getArchiveDocumentCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/GetArchiveDocumentResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ArchiveApi~getArchiveDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/GetArchiveDocumentResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ArchiveApi~listArchiveDocumentsCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ListArchiveDocumentsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ArchiveApi~listArchiveDocumentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ListArchiveDocumentsResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ArchiveApi~modifyArchiveDocumentCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ModifyArchiveDocumentResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} documentId The ID of the document.
     * @param {Object} opts Optional parameters
     * @param {module:FattureInCloud/model/ModifyArchiveDocumentRequest} opts.modifyArchiveDocumentRequest Modified Archive Document
     * @param {module:FattureInCloud/api/ArchiveApi~modifyArchiveDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ModifyArchiveDocumentResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ArchiveApi~uploadArchiveDocumentAttachmentCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/UploadArchiveAttachmentResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ArchiveApi~uploadArchiveDocumentAttachmentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/UploadArchiveAttachmentResponse}
     */
