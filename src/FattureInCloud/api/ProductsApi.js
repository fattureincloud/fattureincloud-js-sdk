...
/**
* Products service.
* @module FattureInCloud/api/ProductsApi
* @version 2.0.1
*/
export default class ProductsApi {
    ...
    * @alias module:FattureInCloud/api/ProductsApi
    * @class
    ...
    */
     ...
     * @callback module:FattureInCloud/api/ProductsApi~createProductCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/CreateProductResponse} data The data returned by the service call.
     ...
     * @param {module:FattureInCloud/model/CreateProductRequest} opts.createProductRequest 
     * @param {module:FattureInCloud/api/ProductsApi~createProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/CreateProductResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ProductsApi~deleteProductCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:FattureInCloud/api/ProductsApi~deleteProductCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:FattureInCloud/api/ProductsApi~getProductCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/GetProductResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ProductsApi~getProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/GetProductResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ProductsApi~listProductsCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ListProductsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ProductsApi~listProductsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ListProductsResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ProductsApi~modifyProductCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ModifyProductResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} productId The ID of the product.
     * @param {Object} opts Optional parameters
     * @param {module:FattureInCloud/model/ModifyProductRequest} opts.modifyProductRequest Modified product details.
     * @param {module:FattureInCloud/api/ProductsApi~modifyProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ModifyProductResponse}
     */
