...
/**
* Suppliers service.
* @module FattureInCloud/api/SuppliersApi
* @version 2.0.1
*/
export default class SuppliersApi {
    ...
    * @alias module:FattureInCloud/api/SuppliersApi
    * @class
    ...
    */
     ...
     * @callback module:FattureInCloud/api/SuppliersApi~createSupplierCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/CreateSupplierResponse} data The data returned by the service call.
     ...
     * @param {module:FattureInCloud/model/CreateSupplierRequest} opts.createSupplierRequest The supplier to create
     * @param {module:FattureInCloud/api/SuppliersApi~createSupplierCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/CreateSupplierResponse}
     */
     ...
     * @callback module:FattureInCloud/api/SuppliersApi~deleteSupplierCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:FattureInCloud/api/SuppliersApi~deleteSupplierCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:FattureInCloud/api/SuppliersApi~getSupplierCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/GetSupplierResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/SuppliersApi~getSupplierCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/GetSupplierResponse}
     */
     ...
     * @callback module:FattureInCloud/api/SuppliersApi~listSuppliersCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ListSuppliersResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/SuppliersApi~listSuppliersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ListSuppliersResponse}
     */
     ...
     * @callback module:FattureInCloud/api/SuppliersApi~modifySupplierCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ModifySupplierResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} supplierId The ID of the supplier.
     * @param {Object} opts Optional parameters
     * @param {module:FattureInCloud/model/ModifySupplierRequest} opts.modifySupplierRequest The modified Supplier. First level parameters are managed in delta mode.
     * @param {module:FattureInCloud/api/SuppliersApi~modifySupplierCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ModifySupplierResponse}
     */
