...
/**
* Receipts service.
* @module FattureInCloud/api/ReceiptsApi
* @version 2.0.1
*/
export default class ReceiptsApi {
    ...
    * @alias module:FattureInCloud/api/ReceiptsApi
    * @class
    ...
    */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~createReceiptCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/CreateReceiptResponse} data The data returned by the service call.
     ...
     * @param {module:FattureInCloud/model/CreateReceiptRequest} opts.createReceiptRequest The Receipt to create.
     * @param {module:FattureInCloud/api/ReceiptsApi~createReceiptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/CreateReceiptResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~deleteReceiptCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:FattureInCloud/api/ReceiptsApi~deleteReceiptCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~getReceiptCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/GetReceiptResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ReceiptsApi~getReceiptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/GetReceiptResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~getReceiptPreCreateInfoCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/GetReceiptPreCreateInfoResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId The ID of the company.
     * @param {module:FattureInCloud/api/ReceiptsApi~getReceiptPreCreateInfoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/GetReceiptPreCreateInfoResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~getReceiptsMonthlyTotalsCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/GetReceiptsMonthlyTotalsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId The ID of the company.
     * @param {module:FattureInCloud/model/String} type Receipt Type
     * @param {String} year Year for which you want monthly totals
     * @param {module:FattureInCloud/api/ReceiptsApi~getReceiptsMonthlyTotalsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/GetReceiptsMonthlyTotalsResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~listReceiptsCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ListReceiptsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:FattureInCloud/api/ReceiptsApi~listReceiptsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ListReceiptsResponse}
     */
     ...
     * @callback module:FattureInCloud/api/ReceiptsApi~modifyReceiptCallback
     * @param {String} error Error message, if any.
     * @param {module:FattureInCloud/model/ModifyReceiptResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} documentId The ID of the document.
     * @param {Object} opts Optional parameters
     * @param {module:FattureInCloud/model/ModifyReceiptRequest} opts.modifyReceiptRequest Modified receipt.
     * @param {module:FattureInCloud/api/ReceiptsApi~modifyReceiptCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:FattureInCloud/model/ModifyReceiptResponse}
     */
