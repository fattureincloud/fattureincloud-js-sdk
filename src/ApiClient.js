...
class ApiClient {
  /**
     ...
     */
  constructor (basePath = 'https://api-v2.fattureincloud.it') {
    /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
  ...
  callApi (path, httpMethod, pathParams,
    ...
    if (contentType === 'application/x-www-form-urlencoded') {
      const normalizedParams = this.normalizeParams(formParams)
      const urlSearchParams = new URLSearchParams(normalizedParams)
