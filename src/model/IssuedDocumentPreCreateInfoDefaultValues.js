...
class IssuedDocumentPreCreateInfoDefaultValues {
  ...
  /**
     * Validates the JSON data with respect to <code>IssuedDocumentPreCreateInfoDefaultValues</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IssuedDocumentPreCreateInfoDefaultValues</code>.
     */
  static validateJSON (data) {
    // validate the optional field `default_template`
    if (data.default_template) { // data not null
      DocumentTemplate.validateJSON(data.default_template)
    }
    // validate the optional field `dn_template`
    if (data.dn_template) { // data not null
      DocumentTemplate.validateJSON(data.dn_template)
    }
    // validate the optional field `ai_template`
    if (data.ai_template) { // data not null
      DocumentTemplate.validateJSON(data.ai_template)
    }
