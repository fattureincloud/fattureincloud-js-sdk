...
class IssuedDocumentExtraData {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('debt_vat_detect')) {
        obj.debt_vat_detect = ApiClient.convertToType(data.debt_vat_detect, 'Boolean')
      }
      if (data.hasOwnProperty('revenue_detect')) {
        obj.revenue_detect = ApiClient.convertToType(data.revenue_detect, 'Boolean')
      }
    }
    return obj
  }
 ...
 * @member {Boolean} debt_vat_detect
 */
IssuedDocumentExtraData.prototype.debt_vat_detect = undefined

/**
 * Issued document revenue detect
 * @member {Boolean} revenue_detect
 */
IssuedDocumentExtraData.prototype.revenue_detect = undefined
