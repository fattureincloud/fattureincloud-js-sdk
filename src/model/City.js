...
class City {
     ...
     * @param postal_code {String} City postal code.
     * @param city {String} City name.
     * @param province {String} Province.
     */
    constructor(postal_code, city, province) { 
        
        City.initialize(this, postal_code, city, province);
    }
     ...
     */
    static initialize(obj, postal_code, city, province) { 
