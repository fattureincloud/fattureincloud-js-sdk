  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('intent_declaration_protocol_number')) {
        obj.intent_declaration_protocol_number = ApiClient.convertToType(data.intent_declaration_protocol_number, 'Date')
      }
      if (data.hasOwnProperty('intent_declaration_protocol_date')) {
        obj.intent_declaration_protocol_date = ApiClient.convertToType(data.intent_declaration_protocol_date, 'String')
      }
