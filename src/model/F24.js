...
class F24 {
     ...
     */
    constructor(due_date, amount, description) { 
        
        F24.initialize(this, due_date, amount, description);
    }
     ...
     */
    static initialize(obj, due_date, amount, description) { 
...
/**
 * Tax status.
 * @member {module:model/F24.StatusEnum} status
 */
