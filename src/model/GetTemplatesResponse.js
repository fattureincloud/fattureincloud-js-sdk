...
class GetTemplatesResponse {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj.data = DocumentTemplate.constructFromObject(data.data)
      }
    }
    return obj
  }
  ...
  /**
     * Validates the JSON data with respect to <code>GetTemplatesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplatesResponse</code>.
     */
  static validateJSON (data) {
    // validate the optional field `data`
    if (data.data) { // data not null
      DocumentTemplate.validateJSON(data.data)
    }
...
/**
 * @member {module:model/DocumentTemplate} data
 */
GetTemplatesResponse.prototype.data = undefined
