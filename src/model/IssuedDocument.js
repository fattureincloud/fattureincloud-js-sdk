...
/**
 * @member {Array.<module:model/IssuedDocumentItemsList>} items_list
 */
IssuedDocument.prototype['items_list'] = undefined;

/**
 * @member {Array.<module:model/IssuedDocumentPaymentsList>} payments_list
 */
...
/**
 * Totals mode.
 * @member {module:model/IssuedDocument.ShowTotalsEnum} show_totals
 * @default 'all'
 */
...
/**
 * @member {module:model/IssuedDocumentRefersTo} refers_to
 */
