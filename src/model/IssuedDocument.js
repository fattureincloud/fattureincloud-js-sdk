...
class IssuedDocument {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('price_list_id')) {
        obj.price_list_id = ApiClient.convertToType(data.price_list_id, 'String')
      }
  ...
  static validateJSON (data) {
    ...
    // ensure the json data is a string
    if (data.price_list_id && !(typeof data.price_list_id === 'string' || data.price_list_id instanceof String)) {
      throw new Error('Expected the field `price_list_id` to be a primitive type in the JSON string but got ' + data.price_list_id)
    }
    // ensure the json data is a string
...
/**
 * Price list id
 * @member {String} price_list_id
 */
IssuedDocument.prototype.price_list_id = undefined
