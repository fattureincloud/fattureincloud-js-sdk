...
class ReceivedDocumentTotals {
     ...
     * @param amount_gross {Number} Total gross amount.
     * @param amount_due {Number} Total amount due.
     * @param payments_sum {Number} Payments sum.
     */
    constructor(amount_net, amount_vat, amount_gross, amount_due, payments_sum) { 
        
        ReceivedDocumentTotals.initialize(this, amount_net, amount_vat, amount_gross, amount_due, payments_sum);
    }
     ...
     */
    static initialize(obj, amount_net, amount_vat, amount_gross, amount_due, payments_sum) { 
