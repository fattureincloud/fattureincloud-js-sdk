...
class CashbookEntryInOut {
    ...
    constructor(id, date, description, kind) { 
        CashbookEntryOut.initialize(this, id, date, description, kind);CashbookEntryIn.initialize(this, id, date, description, kind);
        CashbookEntryInOut.initialize(this, id, date, description, kind);
    }
