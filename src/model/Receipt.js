...
class Receipt {
     ...
     * @param type {module:model/ReceiptType} 
     * @param payment_account {module:model/PaymentAccount} 
     */
    constructor(date, type, payment_account) { 
        
        Receipt.initialize(this, date, type, payment_account);
    }
     ...
     */
    static initialize(obj, date, type, payment_account) { 
        obj['date'] = date;
        obj['type'] = type;
        obj['payment_account'] = payment_account;
    }
