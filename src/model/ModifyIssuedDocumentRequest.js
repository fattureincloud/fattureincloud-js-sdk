    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('option')) {
                obj['option'] = EntityOptions.constructFromObject(data['option']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/EntityOptions} option
 */
ModifyIssuedDocumentRequest.prototype['option'] = undefined;
