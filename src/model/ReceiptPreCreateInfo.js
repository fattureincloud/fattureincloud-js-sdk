...
class ReceiptPreCreateInfo {
     ...
     * @param numerations_list {Array.<String>} List of series used in the past.
     * @param rc_centers_list {Array.<String>} List of revenue centers used in the past.
     * @param payment_accounts_list {Array.<module:model/PaymentAccount>} User payment accounts list.
     * @param categories_list {Array.<String>} List of categories used in the past.
     * @param vat_types_list {Array.<module:model/VatType>} List of user vat types with the default 22%, 10%, 4% and 0% vats.
     */
    constructor(numerations, numerations_list, rc_centers_list, payment_accounts_list, categories_list, vat_types_list) { 
        
        ReceiptPreCreateInfo.initialize(this, numerations, numerations_list, rc_centers_list, payment_accounts_list, categories_list, vat_types_list);
    }
     ...
     */
    static initialize(obj, numerations, numerations_list, rc_centers_list, payment_accounts_list, categories_list, vat_types_list) { 
        obj['numerations'] = numerations;
        obj['numerations_list'] = numerations_list;
        obj['rc_centers_list'] = rc_centers_list;
        obj['payment_accounts_list'] = payment_accounts_list;
        obj['categories_list'] = categories_list;
        obj['vat_types_list'] = vat_types_list;
    }
