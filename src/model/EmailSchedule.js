...
class EmailSchedule {
     ...
     * @param recipient_email {String} One or more comma separated recipient emails
     * @param subject {String} Email subject
     * @param body {String} Email body
     * @param include {module:model/EmailScheduleInclude} 
     * @param attach_pdf {Boolean} If set to true, documents will be sent as PDF attachments too
     * @param send_copy {Boolean} If set to true, a copy of the email will be sent to the `cc_email` specified by `Get email data`
     */
    constructor(recipient_email, subject, body, include, attach_pdf, send_copy) { 
        
        EmailSchedule.initialize(this, recipient_email, subject, body, include, attach_pdf, send_copy);
    }
     ...
     */
    static initialize(obj, recipient_email, subject, body, include, attach_pdf, send_copy) { 
        obj['recipient_email'] = recipient_email;
        obj['subject'] = subject;
        obj['body'] = body;
        obj['include'] = include;
        obj['attach_pdf'] = attach_pdf;
        obj['send_copy'] = send_copy;
    }
