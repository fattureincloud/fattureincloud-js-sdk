...
class EmailScheduleInclude {
     ...
     * @param delivery_note {Boolean} If set to true, the email will have a button to view the delivery note
     * @param attachment {Boolean} If set to true, the email will have a button to view the attachment
     * @param accompanying_invoice {Boolean} If set to true, the email will have a button to view the accompanying invoice
     */
    constructor(document, delivery_note, attachment, accompanying_invoice) { 
        
        EmailScheduleInclude.initialize(this, document, delivery_note, attachment, accompanying_invoice);
    }
     ...
     */
    static initialize(obj, document, delivery_note, attachment, accompanying_invoice) { 
        obj['document'] = document;
        obj['delivery_note'] = delivery_note;
        obj['attachment'] = attachment;
        obj['accompanying_invoice'] = accompanying_invoice;
    }
