...
class ReceivedDocument {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ei_reception_date')) {
        obj.ei_reception_date = ApiClient.convertToType(data.ei_reception_date, 'String')
      }
      if (data.hasOwnProperty('is_from_pending_expenses')) {
        obj.is_from_pending_expenses = ApiClient.convertToType(data.is_from_pending_expenses, 'Boolean')
      }
    }
    return obj
  }
  ...
  static validateJSON (data) {
    ...
    // ensure the json data is a string
    if (data.ei_reception_date && !(typeof data.ei_reception_date === 'string' || data.ei_reception_date instanceof String)) {
      throw new Error('Expected the field `ei_reception_date` to be a primitive type in the JSON string but got ' + data.ei_reception_date)
    }
 ...
 * @member {String} ei_reception_date
 */
ReceivedDocument.prototype.ei_reception_date = undefined

/**
 * [Read Only] True if received document is generated from pending expenses,  needs fic_view fieldset
 * @member {Boolean} is_from_pending_expenses
 */
ReceivedDocument.prototype.is_from_pending_expenses = undefined
