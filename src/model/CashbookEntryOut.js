...
class CashbookEntryOut {
    ...
    constructor(id, date, description, kind) { 
        CashbookEntryData.initialize(this, id, date, description, kind);CashbookEntryOutData.initialize(this);
        CashbookEntryOut.initialize(this, id, date, description, kind);
    }
