...
import IssuedDocumentTotalsVatList from './IssuedDocumentTotalsVatList';
...
class IssuedDocumentTotals {
     ...
     * @param amount_net {Number} Total net amount.
     * @param amount_vat {Number} Total vat amount.
     * @param amount_gross {Number} Total grosas amount.
     * @param amount_due {Number} Total amount due.
     * @param is_enasarco_maximal_exceeded {Boolean} 
     * @param payments_sum {Number} Payments sum.
     */
    constructor(amount_net, amount_vat, amount_gross, amount_due, is_enasarco_maximal_exceeded, payments_sum) { 
        
        IssuedDocumentTotals.initialize(this, amount_net, amount_vat, amount_gross, amount_due, is_enasarco_maximal_exceeded, payments_sum);
    }
     ...
     */
    static initialize(obj, amount_net, amount_vat, amount_gross, amount_due, is_enasarco_maximal_exceeded, payments_sum) { 
        obj['amount_net'] = amount_net;
        obj['amount_vat'] = amount_vat;
        obj['amount_gross'] = amount_gross;
        obj['amount_due'] = amount_due;
        obj['is_enasarco_maximal_exceeded'] = is_enasarco_maximal_exceeded;
        obj['payments_sum'] = payments_sum;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vat_list')) {
                obj['vat_list'] = IssuedDocumentTotalsVatList.constructFromObject(data['vat_list']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/IssuedDocumentTotalsVatList} vat_list
 */
