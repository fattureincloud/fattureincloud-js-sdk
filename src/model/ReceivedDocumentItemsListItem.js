...
class ReceivedDocumentItemsListItem {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('deductibility_vat_percentage')) {
        obj.deductibility_vat_percentage = ApiClient.convertToType(data.deductibility_vat_percentage, 'Number')
      }
    }
    return obj
  }
 ...
 * @member {Number} deductibility_vat_percentage
 */
ReceivedDocumentItemsListItem.prototype.deductibility_vat_percentage = undefined
