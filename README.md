...
fatture_in_cloud_api_v2_api_reference - JavaScript client for Fatture in Cloud API.
...
```shell
npm install fatture_in_cloud_api_v2_api_reference
```

Using yarn:

```shell
yarn add fatture_in_cloud_api_v2_api_reference
```
...
```javascript
var fattureInCloudSdk = require('fatture_in_cloud_api_v2_api_reference');
