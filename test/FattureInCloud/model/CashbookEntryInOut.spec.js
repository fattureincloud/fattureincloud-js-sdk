...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.CashbookEntryInOut();
  });
  ...
  describe('CashbookEntryInOut', function() {
    it('should create an instance of CashbookEntryInOut', function() {
      ...
      //var instane = new fattureInCloudSdk.CashbookEntryInOut();
      //expect(instance).to.be.a(fattureInCloudSdk.CashbookEntryInOut);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new fattureInCloudSdk.CashbookEntryInOut();
