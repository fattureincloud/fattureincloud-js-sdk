...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.ReceivedDocumentPaymentsList();
  });
  ...
  describe('ReceivedDocumentPaymentsList', function() {
    it('should create an instance of ReceivedDocumentPaymentsList', function() {
      ...
      //var instane = new fattureInCloudSdk.ReceivedDocumentPaymentsList();
      //expect(instance).to.be.a(fattureInCloudSdk.ReceivedDocumentPaymentsList);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new fattureInCloudSdk.ReceivedDocumentPaymentsList();
