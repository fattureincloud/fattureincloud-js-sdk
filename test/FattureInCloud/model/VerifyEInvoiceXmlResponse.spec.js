...
(function(root, factory) {
  ...
  describe('VerifyEInvoiceXmlResponse', function() {
    it('should create an instance of VerifyEInvoiceXmlResponse', function() {
      ...
      //var instane = new fattureInCloudSdk.VerifyEInvoiceXmlResponse();
      //expect(instance).to.be.a(fattureInCloudSdk.VerifyEInvoiceXmlResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new fattureInCloudSdk.VerifyEInvoiceXmlResponse();
