...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.CashbookEntryInData();
  });
  ...
  describe('CashbookEntryInData', function() {
    it('should create an instance of CashbookEntryInData', function() {
      ...
      //var instane = new fattureInCloudSdk.CashbookEntryInData();
      //expect(instance).to.be.a(fattureInCloudSdk.CashbookEntryInData);
    });
    ...
    it('should have the property amountIn (base name: "amount_in")', function() {
      ...
      //var instance = new fattureInCloudSdk.CashbookEntryInData();
