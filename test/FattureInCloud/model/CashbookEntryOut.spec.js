...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.CashbookEntryOut();
  });
  ...
  describe('CashbookEntryOut', function() {
    it('should create an instance of CashbookEntryOut', function() {
      ...
      //var instane = new fattureInCloudSdk.CashbookEntryOut();
      //expect(instance).to.be.a(fattureInCloudSdk.CashbookEntryOut);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new fattureInCloudSdk.CashbookEntryOut();
