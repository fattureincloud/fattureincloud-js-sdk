...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.Pagination();
  });
  ...
  describe('Pagination', function() {
    it('should create an instance of Pagination', function() {
      ...
      //var instane = new fattureInCloudSdk.Pagination();
      //expect(instance).to.be.a(fattureInCloudSdk.Pagination);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new fattureInCloudSdk.Pagination();
