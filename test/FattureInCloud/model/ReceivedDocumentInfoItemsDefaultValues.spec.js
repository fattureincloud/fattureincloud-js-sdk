...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.ReceivedDocumentInfoItemsDefaultValues();
  });
  ...
  describe('ReceivedDocumentInfoItemsDefaultValues', function() {
    it('should create an instance of ReceivedDocumentInfoItemsDefaultValues', function() {
      ...
      //var instane = new fattureInCloudSdk.ReceivedDocumentInfoItemsDefaultValues();
      //expect(instance).to.be.a(fattureInCloudSdk.ReceivedDocumentInfoItemsDefaultValues);
    });

    it('should have the property vat (base name: "vat")', function() {
      // uncomment below and update the code to test the property vat
      //var instance = new fattureInCloudSdk.ReceivedDocumentInfoItemsDefaultValues();
