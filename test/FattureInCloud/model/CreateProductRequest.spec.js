...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.CreateProductRequest();
  });
  ...
  describe('CreateProductRequest', function() {
    it('should create an instance of CreateProductRequest', function() {
      ...
      //var instane = new fattureInCloudSdk.CreateProductRequest();
      //expect(instance).to.be.a(fattureInCloudSdk.CreateProductRequest);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new fattureInCloudSdk.CreateProductRequest();
