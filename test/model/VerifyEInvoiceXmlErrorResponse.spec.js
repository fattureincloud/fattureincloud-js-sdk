...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlErrorResponse();
    instance.error = {
      message : "errore",
      validation_result : {
          success : false
  ...
  describe('VerifyEInvoiceXmlErrorResponse', function() {
    it('should create an instance of VerifyEInvoiceXmlErrorResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlErrorResponse);
    });
