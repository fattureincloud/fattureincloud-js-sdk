...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListPaymentMethodsResponse();
    instance.data = [
      {
        id : 21,
  ...
  describe('ListPaymentMethodsResponse', function() {
    it('should create an instance of ListPaymentMethodsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListPaymentMethodsResponse);
    });
