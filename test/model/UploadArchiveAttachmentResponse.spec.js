...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.UploadArchiveAttachmentResponse();
    instance.data = {
  ...
  describe('UploadArchiveAttachmentResponse', function() {
    it('should create an instance of UploadArchiveAttachmentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.UploadArchiveAttachmentResponse);
    });
