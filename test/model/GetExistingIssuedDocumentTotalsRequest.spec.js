...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetExistingIssuedDocumentTotalsRequest();
    instance.data = {
      rivalsa : 20
    }
  });
  ...
  describe('GetExistingIssuedDocumentTotalsRequest', function() {
    it('should create an instance of GetExistingIssuedDocumentTotalsRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetExistingIssuedDocumentTotalsRequest);
    });
