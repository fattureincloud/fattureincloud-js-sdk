...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.Entity();
  });
  ...
  describe('Entity', function() {
    it('should create an instance of Entity', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.Entity();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.Entity);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.Entity();
