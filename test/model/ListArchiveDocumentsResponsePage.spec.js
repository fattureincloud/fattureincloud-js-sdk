...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListArchiveDocumentsResponsePage();
    instance.data = [
      {
        id : 12345,
        date : "2021-08-20",
  ...
  describe('ListArchiveDocumentsResponsePage', function() {
    it('should create an instance of ListArchiveDocumentsResponsePage', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListArchiveDocumentsResponsePage);
    });
