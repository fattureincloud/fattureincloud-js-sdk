...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CashbookEntryDataDocument();
    instance.id = 12345;
  ...
  describe('CashbookEntryDataDocument', function() {
    it('should create an instance of CashbookEntryDataDocument', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CashbookEntryDataDocument);
    });
