...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlErrorResponseExtra();
    instance.errors = [
      "errore brutto",
      "errore brutto2"
    ];
  ...
  describe('VerifyEInvoiceXmlErrorResponseExtra', function() {
    it('should create an instance of VerifyEInvoiceXmlErrorResponseExtra', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlErrorResponseExtra);
    });

    it('should have the property errors (base name: "errors")', function() {
      expect(typeof instance.errors).to.be('object');
    });
