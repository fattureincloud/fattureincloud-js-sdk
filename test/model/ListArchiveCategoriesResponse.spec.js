...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListArchiveCategoriesResponse();
    instance.data = [
      "Altri documenti",
      "Conferme d\'ordine",
      "Contratti",
  ...
  describe('ListArchiveCategoriesResponse', function() {
    it('should create an instance of ListArchiveCategoriesResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListArchiveCategoriesResponse);
    });
