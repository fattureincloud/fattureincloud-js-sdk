...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetUserInfoResponseEmailConfirmationState();
  ...
  describe('GetUserInfoResponseEmailConfirmationState', function() {
    it('should create an instance of GetUserInfoResponseEmailConfirmationState', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetUserInfoResponseEmailConfirmationState);
    });
