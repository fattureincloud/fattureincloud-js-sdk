...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetNewIssuedDocumentTotalsResponse();
    instance.data = {
      amount_net : 68.18,
  ...
  describe('GetNewIssuedDocumentTotalsResponse', function() {
    it('should create an instance of GetNewIssuedDocumentTotalsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetNewIssuedDocumentTotalsResponse);
    });
