...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListF24Response();
  });
  ...
  describe('ListF24Response', function() {
    it('should create an instance of ListF24Response', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.ListF24Response();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListF24Response);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListF24Response();
