...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.PaymentMethod();
  });
  ...
  describe('PaymentMethod', function() {
    it('should create an instance of PaymentMethod', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.PaymentMethod();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.PaymentMethod);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.PaymentMethod();
