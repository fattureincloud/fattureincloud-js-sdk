...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CreateArchiveDocumentResponse();
    instance.data = {
      id : 12345,
      date : "2021-08-20",
  ...
  describe('CreateArchiveDocumentResponse', function() {
    it('should create an instance of CreateArchiveDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CreateArchiveDocumentResponse);
    });
