...
(function (root, factory) {
  ...
  describe('ListPendingReceivedDocumentsResponse', function () {
    it('should create an instance of ListPendingReceivedDocumentsResponse', function () {
      // uncomment below and update the code to test ListPendingReceivedDocumentsResponse
      // var instance = new fattureInCloudSdk.ListPendingReceivedDocumentsResponse();
