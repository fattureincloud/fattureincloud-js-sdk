...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new fattureInCloudSdk.ListPendingReceivedDocumentsResponse()
    instance.current_page = 1
    instance.first_page_url = 'page=1'
    instance.from = 1
    instance.last_page = 1
    instance.last_page_url = 'page=1'
    instance.next_page_url = null
    instance.path = '/received_documents'
    instance.per_page = 50
    instance.prev_page_url = null
    instance.to = 2
    instance.total = 2
  ...
  describe('ListPendingReceivedDocumentsResponse', function () {
    it('should create an instance of ListPendingReceivedDocumentsResponse', function () {
      expect(instance).to.be.a(fattureInCloudSdk.ListPendingReceivedDocumentsResponse)
    })
    ...
    it('should have the property nextPageUrl (base name: "next_page_url")', function () {
      expect(instance.next_page_url).to.be(null)
    })
    ...
    it('should have the property prevPageUrl (base name: "prev_page_url")', function () {
      expect(instance.prev_page_url).to.be(null)
    })
    ...
    it('should have the property data (base name: "data")', function () {
      ...
      expect(instance.data[0]).to.be.a(fattureInCloudSdk.PendingReceivedDocument)
    })
  })
}))
