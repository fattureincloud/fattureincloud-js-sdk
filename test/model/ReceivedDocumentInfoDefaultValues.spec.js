...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ReceivedDocumentInfoDefaultValues();
  ...
  describe('ReceivedDocumentInfoDefaultValues', function() {
    it('should create an instance of ReceivedDocumentInfoDefaultValues', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ReceivedDocumentInfoDefaultValues);
    });

    it('should have the property detailed (base name: "detailed")', function() {
      expect(typeof instance.detailed).to.be('boolean');
    });
