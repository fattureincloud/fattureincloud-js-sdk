...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.Client();
  });
  ...
  describe('Client', function() {
    it('should create an instance of Client', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.Client();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.Client);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.Client();
