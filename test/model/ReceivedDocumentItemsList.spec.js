...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.ReceivedDocumentItemsList();
  });
  ...
  describe('ReceivedDocumentItemsList', function() {
    it('should create an instance of ReceivedDocumentItemsList', function() {
      ...
      //var instane = new fattureInCloudSdk.ReceivedDocumentItemsList();
      //expect(instance).to.be.a(fattureInCloudSdk.ReceivedDocumentItemsList);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new fattureInCloudSdk.ReceivedDocumentItemsList();
