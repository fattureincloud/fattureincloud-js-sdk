...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentItemsList();
  });
  ...
  describe('ReceivedDocumentItemsList', function() {
    it('should create an instance of ReceivedDocumentItemsList', function() {
      // uncomment below and update the code to test ReceivedDocumentItemsList
      //var instane = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentItemsList();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ReceivedDocumentItemsList);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentItemsList();
