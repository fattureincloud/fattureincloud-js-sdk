...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoLimits();
  });
  ...
  describe('CompanyInfoPlanInfoLimits', function() {
    it('should create an instance of CompanyInfoPlanInfoLimits', function() {
      // uncomment below and update the code to test CompanyInfoPlanInfoLimits
      //var instane = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoLimits();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoLimits);
    });
    ...
    it('should have the property clients (base name: "clients")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoLimits();
