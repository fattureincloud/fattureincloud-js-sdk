...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CreateCashbookEntryResponse();
    instance.data = {
      id : 54321,
      date : "2021-08-24",
      amount_in : 122,
  ...
  describe('CreateCashbookEntryResponse', function() {
    it('should create an instance of CreateCashbookEntryResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CreateCashbookEntryResponse);
    });
