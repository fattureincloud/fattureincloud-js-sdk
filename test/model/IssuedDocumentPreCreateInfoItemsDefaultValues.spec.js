...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.IssuedDocumentPreCreateInfoItemsDefaultValues();
    instance.vat = {
      id : 0,
      value : 22,
      description : "iva",
  ...
  describe('IssuedDocumentPreCreateInfoItemsDefaultValues', function() {
    it('should create an instance of IssuedDocumentPreCreateInfoItemsDefaultValues', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.IssuedDocumentPreCreateInfoItemsDefaultValues);
    });
