...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentTotals();
  });
  ...
  describe('ReceivedDocumentTotals', function() {
    it('should create an instance of ReceivedDocumentTotals', function() {
      // uncomment below and update the code to test ReceivedDocumentTotals
      //var instane = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentTotals();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ReceivedDocumentTotals);
    });
    ...
    it('should have the property amountNet (base name: "amount_net")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentTotals();
