...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetArchiveDocumentResponse();
    instance.data = {
      id : 12345,
      date : "2021-08-20",
  ...
  describe('GetArchiveDocumentResponse', function() {
    it('should create an instance of GetArchiveDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetArchiveDocumentResponse);
    });
