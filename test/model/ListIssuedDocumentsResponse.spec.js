...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListIssuedDocumentsResponse();
  });
  ...
  describe('ListIssuedDocumentsResponse', function() {
    it('should create an instance of ListIssuedDocumentsResponse', function() {
      // uncomment below and update the code to test ListIssuedDocumentsResponse
      //var instane = new @FattureincloudFattureincloudJsSdk.ListIssuedDocumentsResponse();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListIssuedDocumentsResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListIssuedDocumentsResponse();
