...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.ListIssuedDocumentsResponse();
  });
  ...
  describe('ListIssuedDocumentsResponse', function() {
    it('should create an instance of ListIssuedDocumentsResponse', function() {
      ...
      //var instane = new fattureInCloudSdk.ListIssuedDocumentsResponse();
      //expect(instance).to.be.a(fattureInCloudSdk.ListIssuedDocumentsResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new fattureInCloudSdk.ListIssuedDocumentsResponse();
