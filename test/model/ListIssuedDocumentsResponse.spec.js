...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListIssuedDocumentsResponse();
  ...
  describe('ListIssuedDocumentsResponse', function() {
    it('should create an instance of ListIssuedDocumentsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListIssuedDocumentsResponse);
    });
