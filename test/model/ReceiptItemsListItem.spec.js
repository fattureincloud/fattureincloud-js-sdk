...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ReceiptItemsListItem();
  });
  ...
  describe('ReceiptItemsListItem', function() {
    it('should create an instance of ReceiptItemsListItem', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.ReceiptItemsListItem();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ReceiptItemsListItem);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceiptItemsListItem();
