...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListDeliveryNotesDefaultCausalsResponse();
    instance.data = [
      "Vendita",
      "Conto visione",
      "Conto deposito",
  ...
  describe('ListDeliveryNotesDefaultCausalsResponse', function() {
    it('should create an instance of ListDeliveryNotesDefaultCausalsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListDeliveryNotesDefaultCausalsResponse);
    });
