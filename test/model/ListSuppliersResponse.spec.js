...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fattureInCloudSdk.ListSuppliersResponse();
  });
  ...
  describe('ListSuppliersResponse', function() {
    it('should create an instance of ListSuppliersResponse', function() {
      ...
      //var instane = new fattureInCloudSdk.ListSuppliersResponse();
      //expect(instance).to.be.a(fattureInCloudSdk.ListSuppliersResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new fattureInCloudSdk.ListSuppliersResponse();
