...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListSuppliersResponse();
  });
  ...
  describe('ListSuppliersResponse', function() {
    it('should create an instance of ListSuppliersResponse', function() {
      // uncomment below and update the code to test ListSuppliersResponse
      //var instane = new @FattureincloudFattureincloudJsSdk.ListSuppliersResponse();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListSuppliersResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListSuppliersResponse();
