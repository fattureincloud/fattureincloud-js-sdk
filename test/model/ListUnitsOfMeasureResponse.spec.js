...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListUnitsOfMeasureResponse();
    instance.data = [
      {
        id : 10,
  ...
  describe('ListUnitsOfMeasureResponse', function() {
    it('should create an instance of ListUnitsOfMeasureResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListUnitsOfMeasureResponse);
    });
