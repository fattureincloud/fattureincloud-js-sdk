...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.EmailScheduleInclude();
  });
  ...
  describe('EmailScheduleInclude', function() {
    it('should create an instance of EmailScheduleInclude', function() {
      // uncomment below and update the code to test EmailScheduleInclude
      //var instane = new @FattureincloudFattureincloudJsSdk.EmailScheduleInclude();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.EmailScheduleInclude);
    });
    ...
    it('should have the property document (base name: "document")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.EmailScheduleInclude();
