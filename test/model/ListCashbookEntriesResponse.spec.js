...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListCashbookEntriesResponse();
    instance.data = [
      {
        date : "2021-08-24",
        amount_in : 122,
  ...
  describe('ListCashbookEntriesResponse', function() {
    it('should create an instance of ListCashbookEntriesResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListCashbookEntriesResponse);
    });
