...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CreateReceivedDocumentResponse();
    instance.data = {
      id : 12345,
      type : "expense",
  ...
  describe('CreateReceivedDocumentResponse', function() {
    it('should create an instance of CreateReceivedDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CreateReceivedDocumentResponse);
    });
