...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentEiData();
  });
  ...
  describe('IssuedDocumentEiData', function() {
    it('should create an instance of IssuedDocumentEiData', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.IssuedDocumentEiData();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.IssuedDocumentEiData);
    });
    ...
    it('should have the property vatKind (base name: "vat_kind")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentEiData();
