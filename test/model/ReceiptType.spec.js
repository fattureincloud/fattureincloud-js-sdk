...
(function(root, factory) {
  ...
  describe('ReceiptType', function() {
    it('should create an instance of ReceiptType', function() {
      // uncomment below and update the code to test ReceiptType
      //var instane = new @FattureincloudFattureincloudJsSdk.ReceiptType();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ReceiptType);
    });
