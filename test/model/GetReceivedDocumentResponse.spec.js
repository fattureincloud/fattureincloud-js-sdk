...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetReceivedDocumentResponse();
    instance.data = {
      id : 12345,
      type : "expense",
  ...
  describe('GetReceivedDocumentResponse', function() {
    it('should create an instance of GetReceivedDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetReceivedDocumentResponse);
    });
