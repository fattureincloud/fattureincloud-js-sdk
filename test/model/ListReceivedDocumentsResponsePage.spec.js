...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListReceivedDocumentsResponsePage();
    instance.data = [
      {
        id : 12345,
        type : "expense",
  ...
  describe('ListReceivedDocumentsResponsePage', function() {
    it('should create an instance of ListReceivedDocumentsResponsePage', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListReceivedDocumentsResponsePage);
    });
