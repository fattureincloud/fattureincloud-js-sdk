...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyClientResponse();
    instance.data = {
      code : "AE86",
  ...
  describe('ModifyClientResponse', function() {
    it('should create an instance of ModifyClientResponse', function() {
      ...
      //var instane = new FattureInCloudApiV2ApiReference.ModifyClientResponse();
      //expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyClientResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new FattureInCloudApiV2ApiReference.ModifyClientResponse();
