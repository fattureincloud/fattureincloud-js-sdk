...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.SendEInvoiceRequestData();
  ...
  describe('SendEInvoiceRequestData', function() {
    it('should create an instance of SendEInvoiceRequestData', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.SendEInvoiceRequestData);
    });

    it('should have the property cassaType (base name: "cassa_type")', function() {
      expect(typeof instance.cassa_type).to.be('string');
    });

    it('should have the property withholdingTaxCausal (base name: "withholding_tax_causal")', function() {
      expect(typeof instance.withholding_tax_causal).to.be('string');
    });
