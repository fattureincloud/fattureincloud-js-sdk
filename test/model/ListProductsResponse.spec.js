...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListProductsResponse();
  });
  ...
  describe('ListProductsResponse', function() {
    it('should create an instance of ListProductsResponse', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.ListProductsResponse();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListProductsResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListProductsResponse();
