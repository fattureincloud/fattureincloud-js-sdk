...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentTotals();
  });
  ...
  describe('IssuedDocumentTotals', function() {
    it('should create an instance of IssuedDocumentTotals', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.IssuedDocumentTotals();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.IssuedDocumentTotals);
    });
    ...
    it('should have the property amountNet (base name: "amount_net")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentTotals();
