...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.UploadIssuedDocumentAttachmentResponseData();
  ...
  describe('UploadIssuedDocumentAttachmentResponseData', function() {
    it('should create an instance of UploadIssuedDocumentAttachmentResponseData', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.UploadIssuedDocumentAttachmentResponseData);
    });
