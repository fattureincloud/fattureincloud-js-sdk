...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyPaymentAccountResponse();
    instance.data = {
      id : 12345,
      name : "Indesa",
      type : "bank",
  ...
  describe('ModifyPaymentAccountResponse', function() {
    it('should create an instance of ModifyPaymentAccountResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyPaymentAccountResponse);
    });
