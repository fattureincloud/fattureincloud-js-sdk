...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.Pagination();
  });
  ...
  describe('Pagination', function() {
    it('should create an instance of Pagination', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.Pagination();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.Pagination);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.Pagination();
