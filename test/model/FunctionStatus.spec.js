...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.FunctionStatus();
  ...
  describe('FunctionStatus', function() {
    it('should create an instance of FunctionStatus', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.FunctionStatus);
    });

    it('should have the property active (base name: "active")', function() {
      expect(typeof instance.active).to.be('boolean');
    });
