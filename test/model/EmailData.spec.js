...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.EmailData();
  });
  ...
  describe('EmailData', function() {
    it('should create an instance of EmailData', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.EmailData();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.EmailData);
    });
    ...
    it('should have the property recipientEmail (base name: "recipient_email")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.EmailData();
