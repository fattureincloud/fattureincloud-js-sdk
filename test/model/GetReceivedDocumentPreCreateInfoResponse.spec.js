...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetReceivedDocumentPreCreateInfoResponse();
    instance.data = {
      default_values : {
          detailed : false
      },
  ...
  describe('GetReceivedDocumentPreCreateInfoResponse', function() {
    it('should create an instance of GetReceivedDocumentPreCreateInfoResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetReceivedDocumentPreCreateInfoResponse);
    });
