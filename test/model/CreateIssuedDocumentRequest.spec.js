...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CreateIssuedDocumentRequest();
    instance.data = {
      type : "invoice",
      numeration : "rec123",
      subject : "",
  ...
  describe('CreateIssuedDocumentRequest', function() {
    it('should create an instance of CreateIssuedDocumentRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CreateIssuedDocumentRequest);
    });
