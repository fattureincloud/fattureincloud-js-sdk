...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListUserCompaniesResponseData();
    instance.companies = [
      {
        id : 12345,
  ...
  describe('ListUserCompaniesResponseData', function() {
    it('should create an instance of ListUserCompaniesResponseData', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListUserCompaniesResponseData);
    });
