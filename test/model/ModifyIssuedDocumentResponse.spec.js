...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyIssuedDocumentResponse();
    instance.data = {
      id : 12345,
      type : "receipt",
      year : 2021,
  ...
  describe('ModifyIssuedDocumentResponse', function() {
    it('should create an instance of ModifyIssuedDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyIssuedDocumentResponse);
    });
