...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.PaymentMethodDetails();
  ...
  describe('PaymentMethodDetails', function() {
    it('should create an instance of PaymentMethodDetails', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.PaymentMethodDetails);
    });

    it('should have the property title (base name: "title")', function() {
      expect(typeof instance.title).to.be('string');
    });
