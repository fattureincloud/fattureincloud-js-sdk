...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.UploadReceivedDocumentAttachmentResponse();
    instance.data = {
  ...
  describe('UploadReceivedDocumentAttachmentResponse', function() {
    it('should create an instance of UploadReceivedDocumentAttachmentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.UploadReceivedDocumentAttachmentResponse);
    });
