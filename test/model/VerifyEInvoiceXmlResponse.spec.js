...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlResponse();
    instance.error = {
      message : "errore",
      validation_result : {
          success : false
  ...
  describe('VerifyEInvoiceXmlResponse', function() {
    it('should create an instance of VerifyEInvoiceXmlResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlResponse);
    });
