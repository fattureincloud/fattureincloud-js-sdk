...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ArchiveDocument();
  });
  ...
  describe('ArchiveDocument', function() {
    it('should create an instance of ArchiveDocument', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.ArchiveDocument();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ArchiveDocument);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.ArchiveDocument();
