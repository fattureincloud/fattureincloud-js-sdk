...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.SendEInvoiceResponseData();
    instance.name = "CARICATO";
    instance.date = "2021-08-23 10";
  });
  ...
  describe('SendEInvoiceResponseData', function() {
    it('should create an instance of SendEInvoiceResponseData', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.SendEInvoiceResponseData);
    });
