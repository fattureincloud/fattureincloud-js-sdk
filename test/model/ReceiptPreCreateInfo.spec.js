...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ReceiptPreCreateInfo();
  });
  ...
  describe('ReceiptPreCreateInfo', function() {
    it('should create an instance of ReceiptPreCreateInfo', function() {
      // uncomment below and update the code to test ReceiptPreCreateInfo
      //var instane = new @FattureincloudFattureincloudJsSdk.ReceiptPreCreateInfo();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ReceiptPreCreateInfo);
    });
    ...
    it('should have the property numerations (base name: "numerations")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceiptPreCreateInfo();
      //expect(instance).to.be();
    });

    it('should have the property numerationsList (base name: "numerations_list")', function() {
      // uncomment below and update the code to test the property numerationsList
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceiptPreCreateInfo();
      //expect(instance).to.be();
    });

    it('should have the property rcCentersList (base name: "rc_centers_list")', function() {
      // uncomment below and update the code to test the property rcCentersList
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceiptPreCreateInfo();
      //expect(instance).to.be();
    });
