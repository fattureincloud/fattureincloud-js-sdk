...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.EmailDataSenderEmailsList();
    instance.id = 0;
  ...
  describe('EmailDataSenderEmailsList', function() {
    it('should create an instance of EmailDataSenderEmailsList', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.EmailDataSenderEmailsList);
    });
