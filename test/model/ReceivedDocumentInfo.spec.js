...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentInfo();
  });
  ...
  describe('ReceivedDocumentInfo', function() {
    it('should create an instance of ReceivedDocumentInfo', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentInfo();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ReceivedDocumentInfo);
    });
    ...
    it('should have the property defaultValues (base name: "default_values")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ReceivedDocumentInfo();
