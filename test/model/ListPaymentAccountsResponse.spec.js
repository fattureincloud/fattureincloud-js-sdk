...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListPaymentAccountsResponse();
    instance.data = [
      {
        id : 21,
  ...
  describe('ListPaymentAccountsResponse', function() {
    it('should create an instance of ListPaymentAccountsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListPaymentAccountsResponse);
    });
