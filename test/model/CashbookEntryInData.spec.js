...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CashbookEntryInData();
    instance.amount_in = 12345;
  ...
  describe('CashbookEntryInData', function() {
    it('should create an instance of CashbookEntryInData', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CashbookEntryInData);
    });
