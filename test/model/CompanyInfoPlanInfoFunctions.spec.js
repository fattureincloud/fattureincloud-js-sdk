...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctions();
  });
  ...
  describe('CompanyInfoPlanInfoFunctions', function() {
    it('should create an instance of CompanyInfoPlanInfoFunctions', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctions();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctions);
    });
    ...
    it('should have the property archive (base name: "archive")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctions();
