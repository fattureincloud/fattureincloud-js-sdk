...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.IssuedDocumentTotalsVatListVatItem();
  ...
  describe('IssuedDocumentTotalsVatListVatItem', function() {
    it('should create an instance of IssuedDocumentTotalsVatListVatItem', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.IssuedDocumentTotalsVatListVatItem);
    });
