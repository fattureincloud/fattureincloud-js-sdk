...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfoDefaultValues();
  });
  ...
  describe('IssuedDocumentPreCreateInfoDefaultValues', function() {
    it('should create an instance of IssuedDocumentPreCreateInfoDefaultValues', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfoDefaultValues();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfoDefaultValues);
    });
    ...
    it('should have the property defaultTemplate (base name: "default_template")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfoDefaultValues();
