...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.Currency();
    instance.id = "EUR";
    instance.symbol = "€";
  ...
  describe('Currency', function() {
    it('should create an instance of Currency', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.Currency);
    });
