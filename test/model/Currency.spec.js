...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.Currency();
  });
  ...
  describe('Currency', function() {
    it('should create an instance of Currency', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.Currency();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.Currency);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.Currency();
