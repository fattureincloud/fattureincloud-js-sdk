...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyArchiveDocumentRequest();
    instance.data = {
      date : "2021-08-20",
  ...
  describe('ModifyArchiveDocumentRequest', function() {
    it('should create an instance of ModifyArchiveDocumentRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyArchiveDocumentRequest);
    });
