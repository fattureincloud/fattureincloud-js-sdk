...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyIssuedDocumentRequest();
    instance.data = {
      id : 12345,
      type : "receipt",
      year : 2021,
  ...
  describe('ModifyIssuedDocumentRequest', function() {
    it('should create an instance of ModifyIssuedDocumentRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyIssuedDocumentRequest);
    });
