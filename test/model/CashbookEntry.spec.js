...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.CashbookEntry();
  });
  ...
  describe('CashbookEntry', function() {
    it('should create an instance of CashbookEntry', function() {
      // uncomment below and update the code to test CashbookEntry
      //var instane = new @FattureincloudFattureincloudJsSdk.CashbookEntry();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.CashbookEntry);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.CashbookEntry();
