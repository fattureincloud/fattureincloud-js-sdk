...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.City();
  });
  ...
  describe('City', function() {
    it('should create an instance of City', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.City();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.City);
    });

    it('should have the property postalCode (base name: "postal_code")', function() {
      // uncomment below and update the code to test the property postalCode
      //var instance = new @FattureincloudFattureincloudJsSdk.City();
