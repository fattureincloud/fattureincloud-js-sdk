...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctionsStatus();
  });
  ...
  describe('CompanyInfoPlanInfoFunctionsStatus', function() {
    it('should create an instance of CompanyInfoPlanInfoFunctionsStatus', function() {
      // uncomment below and update the code to test CompanyInfoPlanInfoFunctionsStatus
      //var instane = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctionsStatus();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctionsStatus);
    });
    ...
    it('should have the property tsDigital (base name: "ts_digital")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.CompanyInfoPlanInfoFunctionsStatus();
