...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CompanyInfoPlanInfoFunctionsStatus();
    instance.ts_digital = {
      active : true
    },
    instance.ts_pay = {
  ...
  describe('CompanyInfoPlanInfoFunctionsStatus', function() {
    it('should create an instance of CompanyInfoPlanInfoFunctionsStatus', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CompanyInfoPlanInfoFunctionsStatus);
    });
