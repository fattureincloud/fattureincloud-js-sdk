...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListReceiptsResponse();
  });
  ...
  describe('ListReceiptsResponse', function() {
    it('should create an instance of ListReceiptsResponse', function() {
      // uncomment below and update the code to test ListReceiptsResponse
      //var instane = new @FattureincloudFattureincloudJsSdk.ListReceiptsResponse();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListReceiptsResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListReceiptsResponse();
