...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetNewReceivedDocumentTotalsRequest();
    instance.data = {
      id : 12345,
      type : "expense",
  ...
  describe('GetNewReceivedDocumentTotalsRequest', function() {
    it('should create an instance of GetNewReceivedDocumentTotalsRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetNewReceivedDocumentTotalsRequest);
    });
