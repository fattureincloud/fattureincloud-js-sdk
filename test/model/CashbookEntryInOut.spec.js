...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.CashbookEntryInOut();
  });
  ...
  describe('CashbookEntryInOut', function() {
    it('should create an instance of CashbookEntryInOut', function() {
      // uncomment below and update the code to test CashbookEntryInOut
      //var instane = new @FattureincloudFattureincloudJsSdk.CashbookEntryInOut();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.CashbookEntryInOut);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.CashbookEntryInOut();
