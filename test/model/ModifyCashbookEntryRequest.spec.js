...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyCashbookEntryRequest();
    instance.data = {
      date : "2021-08-24",
      amount_in : 122,
      payment_account_in : {
  ...
  describe('ModifyCashbookEntryRequest', function() {
    it('should create an instance of ModifyCashbookEntryRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyCashbookEntryRequest);
    });
