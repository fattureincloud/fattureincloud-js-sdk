...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.IssuedDocumentPreCreateInfoExtraDataDefaultValues();
  ...
  describe('IssuedDocumentPreCreateInfoExtraDataDefaultValues', function() {
    it('should create an instance of IssuedDocumentPreCreateInfoExtraDataDefaultValues', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.IssuedDocumentPreCreateInfoExtraDataDefaultValues);
    });
