...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListReceivedDocumentsResponse();
  ...
  describe('ListReceivedDocumentsResponse', function() {
    it('should create an instance of ListReceivedDocumentsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListReceivedDocumentsResponse);
    });
