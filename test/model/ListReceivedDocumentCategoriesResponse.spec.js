...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListReceivedDocumentCategoriesResponse();
    instance.data = [
      "Telefono e internet",
  ...
  describe('ListReceivedDocumentCategoriesResponse', function() {
    it('should create an instance of ListReceivedDocumentCategoriesResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListReceivedDocumentCategoriesResponse);
    });
