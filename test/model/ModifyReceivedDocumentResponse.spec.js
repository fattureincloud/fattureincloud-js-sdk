...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyReceivedDocumentResponse();
    instance.data = {
      id : 12345,
      type : "expense",
  ...
  describe('ModifyReceivedDocumentResponse', function() {
    it('should create an instance of ModifyReceivedDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyReceivedDocumentResponse);
    });
