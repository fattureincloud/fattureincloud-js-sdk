...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.CashbookEntryOut();
  });
  ...
  describe('CashbookEntryOut', function() {
    it('should create an instance of CashbookEntryOut', function() {
      // uncomment below and update the code to test CashbookEntryOut
      //var instane = new @FattureincloudFattureincloudJsSdk.CashbookEntryOut();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.CashbookEntryOut);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.CashbookEntryOut();
