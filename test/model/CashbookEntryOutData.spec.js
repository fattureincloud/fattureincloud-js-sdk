...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.CashbookEntryOutData();
    instance.amount_out = 12345;
  ...
  describe('CashbookEntryOutData', function() {
    it('should create an instance of CashbookEntryOutData', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.CashbookEntryOutData);
    });
