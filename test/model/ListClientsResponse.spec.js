...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListClientsResponse();
  });
  ...
  describe('ListClientsResponse', function() {
    it('should create an instance of ListClientsResponse', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.ListClientsResponse();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListClientsResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListClientsResponse();
