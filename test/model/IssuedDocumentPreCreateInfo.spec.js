...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.IssuedDocumentPreCreateInfo();
...
instance.vat_types_list = [
  ...
  describe('IssuedDocumentPreCreateInfo', function() {
    it('should create an instance of IssuedDocumentPreCreateInfo', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.IssuedDocumentPreCreateInfo);
    });
