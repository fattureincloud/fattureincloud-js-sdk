...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfo();
  });
  ...
  describe('IssuedDocumentPreCreateInfo', function() {
    it('should create an instance of IssuedDocumentPreCreateInfo', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfo();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfo);
    });
    ...
    it('should have the property numerations (base name: "numerations")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPreCreateInfo();
