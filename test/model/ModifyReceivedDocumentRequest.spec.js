...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ModifyReceivedDocumentRequest();
    instance.data = {
      type : "expense",
  ...
  describe('ModifyReceivedDocumentRequest', function() {
    it('should create an instance of ModifyReceivedDocumentRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ModifyReceivedDocumentRequest);
    });
