...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ListArchiveDocumentsResponse();
  });
  ...
  describe('ListArchiveDocumentsResponse', function() {
    it('should create an instance of ListArchiveDocumentsResponse', function() {
      // uncomment below and update the code to test ListArchiveDocumentsResponse
      //var instane = new @FattureincloudFattureincloudJsSdk.ListArchiveDocumentsResponse();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.ListArchiveDocumentsResponse);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.ListArchiveDocumentsResponse();
