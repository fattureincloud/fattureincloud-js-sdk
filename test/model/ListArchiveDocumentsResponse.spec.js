...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListArchiveDocumentsResponse();
  ...
  describe('ListArchiveDocumentsResponse', function() {
    it('should create an instance of ListArchiveDocumentsResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListArchiveDocumentsResponse);
    });
