...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.EmailSchedule();
  });
  ...
  describe('EmailSchedule', function() {
    it('should create an instance of EmailSchedule', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.EmailSchedule();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.EmailSchedule);
    });
    ...
    it('should have the property senderId (base name: "sender_id")', function() {
      ...
      //var instance = new @FattureincloudFattureincloudJsSdk.EmailSchedule();
