...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.PaymentAccount();
  });
  ...
  describe('PaymentAccount', function() {
    it('should create an instance of PaymentAccount', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.PaymentAccount();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.PaymentAccount);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new @FattureincloudFattureincloudJsSdk.PaymentAccount();
    ...
    it('should have the property sia (base name: "sia")', function() {
      // uncomment below and update the code to test the property sia
      //var instance = new @FattureincloudFattureincloudJsSdk.PaymentAccount();
      //expect(instance).to.be();
    });

    it('should have the property cuc (base name: "cuc")', function() {
      // uncomment below and update the code to test the property cuc
      //var instance = new @FattureincloudFattureincloudJsSdk.PaymentAccount();
      //expect(instance).to.be();
    });
