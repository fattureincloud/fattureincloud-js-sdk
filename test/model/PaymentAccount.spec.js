...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.PaymentAccount();
    instance.id = 21;
  ...
  describe('PaymentAccount', function() {
    it('should create an instance of PaymentAccount', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.PaymentAccount);
    });
