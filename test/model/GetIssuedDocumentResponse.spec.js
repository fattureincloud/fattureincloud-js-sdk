...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetIssuedDocumentResponse();
    instance.data = {
      id : 12345,
      type : "invoice",
      year : 2021,
  ...
  describe('GetIssuedDocumentResponse', function() {
    it('should create an instance of GetIssuedDocumentResponse', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetIssuedDocumentResponse);
    });
