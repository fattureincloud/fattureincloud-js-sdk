...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPaymentsList();
  });
  ...
  describe('IssuedDocumentPaymentsList', function() {
    it('should create an instance of IssuedDocumentPaymentsList', function() {
      ...
      //var instane = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPaymentsList();
      //expect(instance).to.be.a(@FattureincloudFattureincloudJsSdk.IssuedDocumentPaymentsList);
    });

    it('should have the property dueDate (base name: "due_date")', function() {
      // uncomment below and update the code to test the property dueDate
      //var instance = new @FattureincloudFattureincloudJsSdk.IssuedDocumentPaymentsList();
