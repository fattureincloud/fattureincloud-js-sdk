...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ListIssuedDocumentsResponsePage();
    instance.data = [
      {
          id : 12345,
          type : "invoice",
  ...
  describe('ListIssuedDocumentsResponsePage', function() {
    it('should create an instance of ListIssuedDocumentsResponsePage', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ListIssuedDocumentsResponsePage);
    });
