...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.GetNewIssuedDocumentTotalsRequest();
    instance.data = {
      id : 12345,
      type : "receipt",
      year : 2021,
  ...
  describe('GetNewIssuedDocumentTotalsRequest', function() {
    it('should create an instance of GetNewIssuedDocumentTotalsRequest', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.GetNewIssuedDocumentTotalsRequest);
    });
