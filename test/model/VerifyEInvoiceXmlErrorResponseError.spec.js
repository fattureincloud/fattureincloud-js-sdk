...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlErrorResponseError();
  ...
  describe('VerifyEInvoiceXmlErrorResponseError', function() {
    it('should create an instance of VerifyEInvoiceXmlErrorResponseError', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.VerifyEInvoiceXmlErrorResponseError);
    });
