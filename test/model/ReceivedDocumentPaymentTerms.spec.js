...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ReceivedDocumentPaymentTerms();
    instance.days = 0;
  ...
  describe('ReceivedDocumentPaymentTerms', function() {
    it('should create an instance of ReceivedDocumentPaymentTerms', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ReceivedDocumentPaymentTerms);
    });
