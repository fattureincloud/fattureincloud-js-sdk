...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FattureInCloudApiV2ApiReference.ReceivedDocumentInfoItemsDefaultValues();
    instance.vat = 21;
  });
  ...
  describe('ReceivedDocumentInfoItemsDefaultValues', function() {
    it('should create an instance of ReceivedDocumentInfoItemsDefaultValues', function() {
      expect(instance).to.be.a(FattureInCloudApiV2ApiReference.ReceivedDocumentInfoItemsDefaultValues);
    });

    it('should have the property vat (base name: "vat")', function() {
      expect(typeof instance.vat).to.be('number');
    });
