...
import GetUserInfoResponse from '../../src/model/GetUserInfoResponse'
import ListUserCompaniesResponse from '../../src/model/ListUserCompaniesResponse';
  ...
  describe('UserApi', function () {
    describe('getUserInfo', function () {
      it('should call getUserInfo successfully', function (done) {
        ...
        const responseObj = Object.assign(new GetUserInfoResponse(), response)
        const expectedJson = JSON.stringify(getUserInfoResponseObj)
    ...
    describe('listUserCompanies', function () {
      it('should call listUserCompanies successfully', function (done) {
        ...
        const responseObj = Object.assign(new ListUserCompaniesResponse(), response)
        const expectedJson = JSON.stringify(listUserCompaniesResponseObj)
        const actualJson = JSON.stringify(responseObj)
        expect(actualJson).to.equal(expectedJson)
        done()
      })
