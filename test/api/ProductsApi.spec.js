...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @FattureincloudFattureincloudJsSdk.ProductsApi();
  });
  ...
  describe('ProductsApi', function() {
    ...
    describe('modifyProduct', function() {
      it('should call modifyProduct successfully', function(done) {
        //uncomment below and update the code to test modifyProduct
        //instance.modifyProduct(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
