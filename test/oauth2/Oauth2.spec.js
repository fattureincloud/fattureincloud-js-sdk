...
(function (root, factory) {
  ...
  describe('test Oauth class', function () {
    ...
    it('should create an instance of OAuth2AuthorizationCodeParams', function () {
      var params = new fattureInCloudSdk.OAuth2AuthorizationCodeParams("EXAMPLE_CODE", "EXAMPLE_STATE")
    ...
    it('should create an instance of OAuth2AuthorizationCodeTokenResponse', function () {
      var params = new fattureInCloudSdk.OAuth2AuthorizationCodeTokenResponse("bearer", "EXAMPLE_ACCESS_TOKEN", "EXAMPLE_REFRESH_TOKEN", 86400)
    ...
    it('test method "getScopeString"', function () {
      ...
      var scopeStr = fattureInCloudSdk.OAuth2AuthorizationCodeManager.getScopeString(scopes)
